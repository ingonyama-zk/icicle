...
const config: Config = {
  ...
  themeConfig:{
    metadata: [
      ...
      {name: 'twitter:title', content: 'Docs | ICICLE'},
      {name: 'twitter:description', content: 'Explore the High-Speed Cryptography Library'},
      {name: 'twitter:image', content: 'https://dev.ingonyama.com/img/logo.png'},
      // title
      {name: 'og:title', content: 'Docs | ICICLE'},
      {name: 'og:description', content: 'Explore the High-Speed Cryptography Library'},
