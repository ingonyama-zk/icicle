...
This is the Rust version of the **Merkle Tree API Documentation** ([C++ documentation](api/cpp/merkle.md)). It mirrors the structure and functionality of the C++ version, providing equivalent APIs in Rust.
