...
func GenerateScalars(size int) core.HostSlice[ScalarField] {
	...
	cSize := (C.int)(size)
	C.m31_generate_scalars(cScalars, cSize)
...
func convertScalarsMontgomery(scalars core.HostOrDeviceSlice, isInto bool) runtime.EIcicleError {
	...
	cErr := C.m31_scalar_convert_montgomery((*C.scalar_t)(cValues), (C.size_t)(cSize), (C._Bool)(isInto), (*C.VecOpsConfig)(cCfg), (*C.scalar_t)(cValues))
