...
func GenerateScalars(size int) core.HostSlice[ExtensionField] {
	...
	cSize := (C.int)(size)
	C.m31_extension_generate_scalars(cScalars, cSize)
...
func (f ExtensionField) Add(f2 *ExtensionField) ExtensionField {
	...
	C.m31_extension_add(cF, cF2, cRes)
...
func (f ExtensionField) Sub(f2 *ExtensionField) ExtensionField {
	...
	C.m31_extension_sub(cF, cF2, cRes)
...
func (f ExtensionField) Mul(f2 *ExtensionField) ExtensionField {
	...
	C.m31_extension_mul(cF, cF2, cRes)
...
func (f ExtensionField) Sqr() ExtensionField {
	...
	C.m31_extension_mul(cF, cF, cRes)
...
func (f ExtensionField) Pow(exp int) ExtensionField {
	...
	C.m31_extension_pow(cF, cExp, cRes)
...
func convertScalarsMontgomery(scalars core.HostOrDeviceSlice, isInto bool) runtime.EIcicleError {
	...
	cErr := C.m31_extension_scalar_convert_montgomery((*C.scalar_t)(cValues), (C.size_t)(cSize), (C._Bool)(isInto), (*C.VecOpsConfig)(cCfg), (*C.scalar_t)(cValues))
