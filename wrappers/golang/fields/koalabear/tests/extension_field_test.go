...
func (s *ExtensionFieldTestSuite) TestExtensionField() {
	...
	s.Run("TestKoalabear_extensionGenerateScalars", test_helpers.TestWrapper(&s.Suite, testKoalabear_extensionGenerateScalars))
	s.Run("TestKoalabear_extensionMongtomeryConversion", test_helpers.TestWrapper(&s.Suite, testKoalabear_extensionMongtomeryConversion))
}
