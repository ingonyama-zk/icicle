...
func VecOp(a, b, out core.HostOrDeviceSlice, config core.VecOpsConfig, op core.VecOps) (ret runtime.EIcicleError) {
	...
	switch op {
	case core.Sub:
		ret = (runtime.EIcicleError)(C.koalabear_extension_vector_sub(cA, cB, cSize, cConfig, cOut))
	case core.Add:
		ret = (runtime.EIcicleError)(C.koalabear_extension_vector_add(cA, cB, cSize, cConfig, cOut))
	case core.Mul:
		ret = (runtime.EIcicleError)(C.koalabear_extension_vector_mul(cA, cB, cSize, cConfig, cOut))
	}
...
func ReductionVecOp(in, out core.HostOrDeviceSlice, config core.VecOpsConfig, op core.ReductionVecOp) (ret runtime.EIcicleError) {
	...
	switch op {
	case core.Sum:
		ret = (runtime.EIcicleError)(C.koalabear_extension_vector_sum(cIn, cSize, cConfig, cOut))
	case core.Product:
		ret = (runtime.EIcicleError)(C.koalabear_extension_vector_product(cIn, cSize, cConfig, cOut))
	case core.Inverse:
		ret = (runtime.EIcicleError)(C.koalabear_extension_vector_inv(cIn, cSize, cConfig, cOut))
	}
