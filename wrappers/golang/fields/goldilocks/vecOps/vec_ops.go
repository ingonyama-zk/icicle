...
func VecOp(a, b, out core.HostOrDeviceSlice, config core.VecOpsConfig, op core.VecOps) (ret runtime.EIcicleError) {
	...
	switch op {
	case core.Sub:
		ret = (runtime.EIcicleError)(C.goldilocks_vector_sub(cA, cB, cSize, cConfig, cOut))
	case core.Add:
		ret = (runtime.EIcicleError)(C.goldilocks_vector_add(cA, cB, cSize, cConfig, cOut))
	case core.Mul:
		ret = (runtime.EIcicleError)(C.goldilocks_vector_mul(cA, cB, cSize, cConfig, cOut))
	}
...
func ReductionVecOp(in, out core.HostOrDeviceSlice, config core.VecOpsConfig, op core.ReductionVecOp) (ret runtime.EIcicleError) {
	...
	switch op {
	case core.Sum:
		ret = (runtime.EIcicleError)(C.goldilocks_vector_sum(cIn, cSize, cConfig, cOut))
	case core.Product:
		ret = (runtime.EIcicleError)(C.goldilocks_vector_product(cIn, cSize, cConfig, cOut))
	}
...
func TransposeMatrix(in, out core.HostOrDeviceSlice, columnSize, rowSize int, config core.VecOpsConfig) runtime.EIcicleError {
	...
	err := (C.goldilocks_matrix_transpose(cIn, cRowSize, cColumnSize, cConfig, cOut))
