...
func (s *ScalarFieldTestSuite) TestScalarField() {
	...
	s.Run("TestGoldilocksGenerateScalars", testWrapper(&s.Suite, testGoldilocksGenerateScalars))
	s.Run("TestGoldilocksMongtomeryConversion", testWrapper(&s.Suite, testGoldilocksMongtomeryConversion))
}
