...
func ECNtt[P any, T any](points core.HostOrDeviceSlice, dir core.NTTDir, cfg *core.NTTConfig[T], results core.HostOrDeviceSlice) core.IcicleError {
	...
	if results.IsOnDevice() {
		...
		resultsPointer = unsafe.Pointer(&results.(core.HostSlice[P])[0])
	}
