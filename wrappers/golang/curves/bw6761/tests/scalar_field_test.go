...
func (s *ScalarFieldTestSuite) TestScalarField() {
	...
	s.Run("TestBw6_761GenerateScalars", test_helpers.TestWrapper(&s.Suite, testBw6_761GenerateScalars))
	s.Run("TestBw6_761MongtomeryConversion", test_helpers.TestWrapper(&s.Suite, testBw6_761MongtomeryConversion))
}
