...
void bw6_761_polynomial_division(
...
void bw6_761_polynomial_evaluate_on_domain(
...
// IntegrityPointer* bw6_761_polynomial_get_coeff_view(PolynomialInst* p, size_t* size /*OUT*/, size_t* device_id
// /*OUT*/); IntegrityPointer* bw6_761_polynomial_get_rou_evaluations_view(PolynomialInst* p, size_t nof_evals, bool
// is_reversed, size_t* size /*OUT*/, size_t* device_id /*OUT*/); const scalar_t*
// bw6_761_polynomial_intergrity_ptr_get(IntegrityPointer* p); bool
// bw6_761_polynomial_intergrity_ptr_is_valid(IntegrityPointer* p); void
// bw6_761_polynomial_intergrity_ptr_destroy(IntegrityPointer* p);
