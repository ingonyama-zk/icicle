...
void bn254_polynomial_division(
...
void bn254_polynomial_evaluate_on_domain(
...
// IntegrityPointer* bn254_polynomial_get_coeff_view(PolynomialInst* p, size_t* size /*OUT*/, size_t* device_id
// /*OUT*/); IntegrityPointer* bn254_polynomial_get_rou_evaluations_view(PolynomialInst* p, size_t nof_evals, bool
// is_reversed, size_t* size /*OUT*/, size_t* device_id /*OUT*/); const scalar_t*
// bn254_polynomial_intergrity_ptr_get(IntegrityPointer* p); bool
// bn254_polynomial_intergrity_ptr_is_valid(IntegrityPointer* p); void
// bn254_polynomial_intergrity_ptr_destroy(IntegrityPointer* p);
