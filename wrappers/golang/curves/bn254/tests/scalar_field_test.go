...
func (s *ScalarFieldTestSuite) TestScalarField() {
	...
	s.Run("TestBn254GenerateScalars", test_helpers.TestWrapper(&s.Suite, testBn254GenerateScalars))
	s.Run("TestBn254MongtomeryConversion", test_helpers.TestWrapper(&s.Suite, testBn254MongtomeryConversion))
}
