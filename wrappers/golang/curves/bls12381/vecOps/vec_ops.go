...
func ReductionVecOp(in, out core.HostOrDeviceSlice, config core.VecOpsConfig, op core.ReductionVecOp) (ret runtime.EIcicleError) {
	...
	switch op {
	case core.Sum:
		ret = (runtime.EIcicleError)(C.bls12_381_vector_sum(cIn, cSize, cConfig, cOut))
	case core.Product:
		ret = (runtime.EIcicleError)(C.bls12_381_vector_product(cIn, cSize, cConfig, cOut))
	case core.Inverse:
		ret = (runtime.EIcicleError)(C.bls12_381_vector_inv(cIn, cSize, cConfig, cOut))
	}
