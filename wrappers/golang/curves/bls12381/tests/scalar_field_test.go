...
func (s *ScalarFieldTestSuite) TestScalarField() {
	...
	s.Run("TestBls12_381GenerateScalars", test_helpers.TestWrapper(&s.Suite, testBls12_381GenerateScalars))
	s.Run("TestBls12_381MongtomeryConversion", test_helpers.TestWrapper(&s.Suite, testBls12_381MongtomeryConversion))
}
