...
func testAgainstGnarkCryptoNtt(suite suite.Suite, size int, scalars core.HostSlice[bls12_381.ScalarField], output core.HostSlice[bls12_381.ScalarField], order core.Ordering, direction core.NTTDir) {
