...
func testAgainstGnarkCryptoMsmG2(suite suite.Suite, scalars core.HostSlice[icicleBls12_381.ScalarField], points core.HostSlice[g2.G2Affine], out g2.G2Projective) {
...
func testAgainstGnarkCryptoMsmG2GnarkCryptoTypes(suite suite.Suite, scalarsFr core.HostSlice[fr.Element], pointsFp core.HostSlice[bls12381.G2Affine], out g2.G2Projective) {
