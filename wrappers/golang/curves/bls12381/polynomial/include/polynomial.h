...
void bls12_381_polynomial_division(
...
void bls12_381_polynomial_evaluate_on_domain(
...
// scalar_t* bls12_381_polynomial_get_coeffs_raw_ptr(PolynomialInst* p, size_t* size /*OUT*/, size_t* device_id
// /*OUT*/); PolynomialInst* bls12_381_polynomial_slice(PolynomialInst* p, size_t offset, size_t stride, size_t size);
// IntegrityPointer* bls12_381_polynomial_get_coeff_view(PolynomialInst* p, size_t* size /*OUT*/, size_t* device_id
// /*OUT*/); IntegrityPointer* bls12_381_polynomial_get_rou_evaluations_view(PolynomialInst* p, size_t nof_evals, bool
// is_reversed, size_t* size /*OUT*/, size_t* device_id /*OUT*/); const scalar_t*
// bls12_381_polynomial_intergrity_ptr_get(IntegrityPointer* p); bool
// bls12_381_polynomial_intergrity_ptr_is_valid(IntegrityPointer* p); void
// bls12_381_polynomial_intergrity_ptr_destroy(IntegrityPointer* p);
