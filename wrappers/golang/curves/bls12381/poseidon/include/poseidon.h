...
cudaError_t bls12_381_poseidon_absorb_many_cuda(
...
cudaError_t bls12_381_poseidon_squeeze_many_cuda(
  const PoseidonInst* poseidon,
...
cudaError_t bls12_381_poseidon_delete_cuda(PoseidonInst* poseidon, DeviceContext* ctx);
