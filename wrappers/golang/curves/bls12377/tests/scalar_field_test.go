...
func (s *ScalarFieldTestSuite) TestScalarField() {
	...
	s.Run("TestBls12_377GenerateScalars", test_helpers.TestWrapper(&s.Suite, testBls12_377GenerateScalars))
	s.Run("TestBls12_377MongtomeryConversion", test_helpers.TestWrapper(&s.Suite, testBls12_377MongtomeryConversion))
}
