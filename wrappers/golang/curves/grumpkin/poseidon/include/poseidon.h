...
cudaError_t grumpkin_poseidon_absorb_many_cuda(
...
cudaError_t grumpkin_poseidon_squeeze_many_cuda(
  const PoseidonInst* poseidon,
...
cudaError_t grumpkin_poseidon_delete_cuda(PoseidonInst* poseidon, DeviceContext* ctx);
