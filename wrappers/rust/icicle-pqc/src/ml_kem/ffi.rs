...
extern "C" {
    ...
    pub(super) fn encapsulate_ffi512(
        message: *const u8,
    ...
    pub(super) fn decapsulate_ffi512(
    ...
    pub(super) fn encapsulate_ffi768(
        message: *const u8,
        public_keys: *const u8,
        config: *const MlKemConfig,
        ciphertexts: *mut u8,
    ...
    pub(super) fn decapsulate_ffi768(
        secret_keys: *const u8,
        ciphertexts: *const u8,
        config: *const MlKemConfig,
        shared_secrets: *mut u8,
    ...
    pub(super) fn encapsulate_ffi1024(
        message: *const u8,
        public_keys: *const u8,
        config: *const MlKemConfig,
        ciphertexts: *mut u8,
    ...
    pub(super) fn decapsulate_ffi1024(
        secret_keys: *const u8,
        ciphertexts: *const u8,
        config: *const MlKemConfig,
        shared_secrets: *mut u8,
