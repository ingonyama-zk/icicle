...
pub trait GateOps<F> {
    fn gate_evaluation(
        ...
        rotations: &Vec<i32>,
        beta: &(impl HostOrDeviceSlice<F> + ?Sized),
        gamma: &(impl HostOrDeviceSlice<F> + ?Sized),
        theta: &(impl HostOrDeviceSlice<F> + ?Sized),
        y: &(impl HostOrDeviceSlice<F> + ?Sized),
        previous_value: &(impl HostOrDeviceSlice<F> + ?Sized),
        calculations: &Vec<i32>,
        i_value_types: &Vec<i32>,
        j_value_types: &Vec<i32>,
        i_value_indices: &Vec<i32>,
        j_value_indices: &Vec<i32>,
        horner_value_types: &Vec<i32>,
        i_horner_value_indices: &Vec<i32>,
        j_horner_value_indices: &Vec<i32>,
        horner_offsets: &Vec<i32>,
        horner_sizes: &Vec<i32>,
    ...
    (
        ...
        impl GateOps<$field> for $field_config {
            fn gate_evaluation(
                ...
                rotations: &Vec<i32>,
                beta: &(impl HostOrDeviceSlice<$field> + ?Sized),
                gamma: &(impl HostOrDeviceSlice<$field> + ?Sized),
                theta: &(impl HostOrDeviceSlice<$field> + ?Sized),
                y: &(impl HostOrDeviceSlice<$field> + ?Sized),
                previous_value: &(impl HostOrDeviceSlice<$field> + ?Sized),
                calculations: &Vec<i32>,
                i_value_types: &Vec<i32>,
                j_value_types: &Vec<i32>,
                i_value_indices: &Vec<i32>,
