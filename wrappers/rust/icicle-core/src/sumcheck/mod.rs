...
pub trait Sumcheck {
    ...
    fn prove(
        ...
        combine_function: impl ReturningValueProgram<Self::Field, Self::ProgSymbol>,
    ...
    ($field_prefix:literal, $field_prefix_ident:ident, $field:ident, $field_cfg:ident) => {
        ...
        impl Sumcheck for SumcheckWrapper {
            ...
            fn prove(
                ...
                mle_poly_size: u64,
                claimed_sum: $field,
                combine_function: impl ReturningValueProgram<Self::Field, Self::ProgSymbol> + Handle,
