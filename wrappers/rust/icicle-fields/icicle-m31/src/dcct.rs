...
pub(crate) mod tests {
    ...
    fn test_evaluate_6() {
        ...
        let coeffs: Vec<ScalarField> = (0u32..1 << LOG)
            ...
            .collect();
        let expected = [
            0x06103dfb, 0x23362583, 0x284f0ee4, 0x6535b85a, 0x33a8d92e, 0x612d2b5f, 0x13e77c3a, 0x536c73a8, 0x24862591,
            0x3890cf71, 0x3a80d4a1, 0x71e33235, 0x4926b47e, 0x329b7b98, 0x5bfa6c0b, 0x76a5ce55, 0x4f35cf25, 0x4be15511,
            0x69d57fdf, 0x533c9f36, 0x56dd7a35, 0x53d3e3fe, 0x7ae749ca, 0x2ac55f9b, 0x0c8f98cb, 0x73738fc3, 0x6c3182de,
            0x399d1b64, 0x22a218e1, 0x4dfbdb78, 0x20a57b4a, 0x1790f920, 0x25cbfdad, 0x4e85b831, 0x3dfabc33, 0x5e402279,
            0x0687b1fd, 0x61c716ce, 0x1ce9cc10, 0x10d8a6cc, 0x7607aa42, 0x74a836f4, 0x5157f85f, 0x681fa712, 0x4c71dfd9,
            0x5531aafc, 0x670d13c7, 0x4f7d8990, 0x39a34de3, 0x5154ecb6, 0x65aad3ef, 0x737b7774, 0x1a447068, 0x0961aae5,
            0x631b8c6c, 0x558ea2a6, 0x23c949af, 0x3f454b45, 0x6294b4ff, 0x3de2ed65, 0x2485ad20, 0x1b6dcced, 0x7566e736,
            0x61bd1df4,
        ]
        .map(ScalarField::from_u32);
