...
use icicle_core::{impl_vec_ops_field, impl_vec_ops_cross_field};
use icicle_core::vec_ops::{VecOps, VecOpsConfig, CrossVecOps};
...
impl_vec_ops_cross_field!("babybear_extension", babybear_cross, ExtensionField, ScalarField, ExtensionCfg);

#[cfg(test)]
pub(crate) mod tests {
    use crate::field::{ExtensionField, ScalarField};
    use icicle_core::{impl_vec_ops_tests, impl_cross_vec_ops_tests};
