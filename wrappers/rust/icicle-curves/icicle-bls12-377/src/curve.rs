...
impl_curve!("bls12_377", bls12_377, CurveCfg, ScalarField, BaseField, ArkG1Config, G1Affine, G1Projective);
#[cfg(feature = "g2")]
impl_curve!("bls12_377G2", bls12_377_g2, G2CurveCfg, ScalarField, G2BaseField, ArkG2Config, G2Affine, G2Projective);
