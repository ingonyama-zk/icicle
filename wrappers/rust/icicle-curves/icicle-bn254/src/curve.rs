...
impl_field!(Bn254ScalarField, "bn254", SCALAR_LIMBS);
...
impl_field!(Bn254BaseField, "bn254_base_field", BASE_LIMBS);
impl_curve!(
    "bn254",
    bn254,
    CurveCfg,
...
#[cfg(not(feature = "no_g2"))]
impl_field!(G2Bn254BaseField, "bn254_g2_base_field", G2_BASE_LIMBS);
#[cfg(not(feature = "no_g2"))]
impl_curve!(
    "bn254_g2",
    bn254_g2,
