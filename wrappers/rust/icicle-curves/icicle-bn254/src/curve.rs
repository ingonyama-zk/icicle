...
impl_curve!("bn254", bn254, CurveCfg, ScalarField, BaseField, ArkG1Config, G1Affine, G1Projective);
#[cfg(feature = "g2")]
impl_curve!("bn254G2", bn254_g2, G2CurveCfg, ScalarField, G2BaseField, ArkG2Config, G2Affine, G2Projective);
