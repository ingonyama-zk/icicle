...
func MsmBLS12377(out *PointBLS12377, points []PointAffineNoInfinityBLS12377, scalars []ScalarField, device_id int) (*PointBLS12377, error) {
...
func MsmG2BatchBLS12377(points *[]G2PointAffine, scalars *[]ScalarField, batchSize, deviceId int) ([]*G2Point, error) {
...
func MsmG2BLS12377(out *G2Point, points []G2PointAffine, scalars []ScalarField, device_id int) (*G2Point, error) {
	if len(points) != len(scalars) {
		return nil, errors.New("error on: len(points) != len(scalars)")
	}
