...
namespace icicle {
  ...
  eIcicleError cpu_create_fri_backend(const Device& device, const size_t folding_factor, const size_t stopping_degree, std::vector<MerkleTree> merkle_trees, std::shared_ptr<FriBackend<S, F>>& backend /*OUT*/)
  {
