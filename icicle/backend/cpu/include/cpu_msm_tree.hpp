...
#include "icicle/decision_tree.h"
  ...
  DecisionTree<NOF_CLASSES_C_TREE_INTEL_G2> msm_c_tree_intel_g2 = DecisionTree<NOF_CLASSES_C_TREE_INTEL_G2>(
    NOF_FEATURES_C_TREE_INTEL_G2,
    thresholds_c_tree_intel_g2,
    indices_c_tree_intel_g2,
    left_childs_c_tree_intel_g2,
    right_childs_c_tree_intel_g2,
    class_predictions_c_tree_intel_g2,
    classes_c_tree_intel_g2);
