...
namespace ntt {
  ...
  struct NTTConfig {
    ...
    S* coset_table;             /**< On-device buffer containing powers of coset generator. Used to perform coset
                                 *   (i)NTTs. Default value: `nullptr` (corresponding to no coset or in other words
                                 *   the coset generated by `S::one()`). */
