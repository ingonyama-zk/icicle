...
namespace m31 {
  ...
  typedef circle_math::CircleCoset<m31::fp_config, m31::scalar_t> coset_t;
  typedef circle_math::CircleDomain<fp_config, scalar_t> domain_t;
  typedef circle_math::LineDomain<m31::fp_config, m31::scalar_t> line_t;
} // namespace m31
