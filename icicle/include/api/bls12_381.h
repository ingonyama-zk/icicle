...
extern "C" cudaError_t bls12_381_g2_precompute_msm_bases_cuda(
  bls12_381::g2_affine_t* bases, int msm_size, msm::MSMConfig& config, bls12_381::g2_affine_t* output_bases);
...
extern "C" cudaError_t bls12_381_precompute_msm_bases_cuda(
  bls12_381::affine_t* bases, int msm_size, msm::MSMConfig& config, bls12_381::affine_t* output_bases);
...
extern "C" cudaError_t bls12_381_poseidon_load_cuda(
  poseidon::Poseidon<bls12_381::scalar_t>** poseidon, unsigned int arity, device_context::DeviceContext& ctx);
...
extern "C" cudaError_t bls12_381_poseidon_delete_cuda(poseidon::Poseidon<bls12_381::scalar_t>* poseidon);

extern "C" cudaError_t bls12_381_mul_cuda(
  bls12_381::scalar_t* vec_a,
  bls12_381::scalar_t* vec_b,
  int n,
...
bls12_381_accumulate_cuda(bls12_381::scalar_t* vec_a, bls12_381::scalar_t* vec_b, int n, vec_ops::VecOpsConfig& config);
