...
FILE_cpp.write(f'std::string round_constants_{t}[] = {{\n')
...
MATRIX_PARTIAL_DIAGONAL_M_1 = [MATRIX_PARTIAL[i,i] for i in range(0, NUM_CELLS)]
# Print MATRIX_FULL
FILE_cpp.write(f'std::string mds_matrix_{t}[] = {{\n')
for row in range(MATRIX_FULL.nrows()):
  ...
  FILE_cpp.write(f'\n')
FILE_cpp.write(f'}};\n\n')
# Print MATRIX_PARTIAL_DIAGONAL_M_1
FILE_cpp.write(f'std::string partial_matrix_{t}[] = {{\n')
print(f'type(MATRIX_PARTIAL_DIAGONAL_M_1) = {type(MATRIX_PARTIAL_DIAGONAL_M_1)}')
print(f'MATRIX_PARTIAL_DIAGONAL_M_1 = {MATRIX_PARTIAL_DIAGONAL_M_1}')
for i in range(len(MATRIX_PARTIAL_DIAGONAL_M_1)):
  print(f"M_P[{i},{i}] = {MATRIX_PARTIAL_DIAGONAL_M_1[i]}")
  FILE_cpp.write(f' "{hex(MATRIX_PARTIAL_DIAGONAL_M_1[i])}"')
  if i != len(MATRIX_PARTIAL_DIAGONAL_M_1) - 1:
    FILE_cpp.write(f',')
FILE_cpp.write(f'\n')
FILE_cpp.write(f'}};\n\n')
