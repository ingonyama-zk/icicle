...
namespace icicle {
  ...
  public:
     ...
     */
    HashBackend(uint64_t output_size, uint64_t default_input_chunk_size = 0, const char* name = "")
        : m_output_size{output_size}, m_default_input_chunk_size{default_input_chunk_size}, m_name_hint(name)
    {
    }
