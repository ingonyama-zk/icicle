...
function(handle_skyscraper TARGET FEATURE_LIST)
  if(SKYSCRAPER AND "SKYSCRAPER" IN_LIST FEATURE_LIST)
    target_compile_definitions(${TARGET} PUBLIC SKYSCRAPER=${SKYSCRAPER})
    target_sources(${TARGET} PRIVATE src/hash/skyscraper.cpp)
    set(SKYSCRAPER ON CACHE BOOL "Enable SKYSCRAPER feature" FORCE)
  else()
    set(SKYSCRAPER OFF CACHE BOOL "SKYSCRAPER not available for this field" FORCE)
  endif()
endfunction()
