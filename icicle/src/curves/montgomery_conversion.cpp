...
namespace icicle {
  ...
  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, affine_convert_montgomery)(
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, affine_convert_montgomery)(input, n, is_into, &config, output);
  }

#ifdef G2_ENABLED
  ICICLE_DISPATCHER_INST(AffineG2ConvertMont, g2_affine_convert_montgomery, AffineG2ConvertMontImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, g2_affine_convert_montgomery)(
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, g2_affine_convert_montgomery)(input, n, is_into, &config, output);
  }
  ...
  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, projective_convert_montgomery)(
  ...
  eIcicleError convert_montgomery(
    const projective_t* input, uint64_t n, bool is_into, const VecOpsConfig& config, projective_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, projective_convert_montgomery)(input, n, is_into, &config, output);
  }

#ifdef G2_ENABLED
  ICICLE_DISPATCHER_INST(ProjectiveG2ConvertMont, g2_projective_convert_montgomery, ProjectiveG2ConvertMontImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, g2_projective_convert_montgomery)(
  ...
  eIcicleError convert_montgomery(
    const g2_projective_t* input, uint64_t n, bool is_into, const VecOpsConfig& config, g2_projective_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, g2_projective_convert_montgomery)(input, n, is_into, &config, output);
  }
