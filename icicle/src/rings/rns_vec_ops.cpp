...
namespace icicle {
  ...
  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_sum)(
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_sum)(vec_a, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(VectorAddRingRnsDispatcher, ring_rns_vector_add, ringRnsVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_add)(
  ...
  eIcicleError vector_add(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_add)(vec_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(VectorAccumulateRingRnsDispatcher, ring_rns_vector_accumulate, ringRnsVectorOpImplInplaceA);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_accumulate)(
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_accumulate)(vec_a, vec_b, size, &config);
  }

  ICICLE_DISPATCHER_INST(VectorSubRingRnsDispatcher, ring_rns_vector_sub, ringRnsVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_sub)(
    const scalar_rns_t* vec_a,
    const scalar_rns_t* vec_b,
    uint64_t size,
    const VecOpsConfig* config,
  ...
  eIcicleError vector_sub(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_sub)(vec_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(VectorMulRingRnsDispatcher, ring_rns_vector_mul, ringRnsVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_mul)(
    const scalar_rns_t* vec_a,
    const scalar_rns_t* vec_b,
    uint64_t size,
    const VecOpsConfig* config,
  ...
  eIcicleError vector_mul(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_mul)(vec_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(VectorMixedMulDispatcher, ring_rns_vector_mixed_mul, mixedVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_mixed_mul)(
  ...
  eIcicleError vector_mul(
    const scalar_rns_t* vec_a, const scalar_t* vec_b, uint64_t size, const VecOpsConfig& config, scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_mixed_mul)(vec_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(VectorDivRingRnsDispatcher, ring_rns_vector_div, ringRnsVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_div)(
    const scalar_rns_t* vec_a,
    const scalar_rns_t* vec_b,
    uint64_t size,
    const VecOpsConfig* config,
  ...
  eIcicleError vector_div(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_div)(vec_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(ScalarAddRingRnsDispatcher, ring_rns_scalar_add_vec, ringRnsVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_add_vec)(
  ...
  eIcicleError scalar_add_vec(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_add_vec)(scalar_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(ScalarSubRingRnsDispatcher, ring_rns_scalar_sub_vec, ringRnsVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_sub_vec)(
    const scalar_rns_t* scalar_a,
    const scalar_rns_t* vec_b,
    uint64_t size,
    const VecOpsConfig* config,
  ...
  eIcicleError scalar_sub_vec(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_sub_vec)(scalar_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(ScalarMulRingRnsDispatcher, ring_rns_scalar_mul_vec, ringRnsVectorOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_mul_vec)(
    const scalar_rns_t* scalar_a,
    const scalar_rns_t* vec_b,
    uint64_t size,
    const VecOpsConfig* config,
  ...
  eIcicleError scalar_mul_vec(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_mul_vec)(scalar_a, vec_b, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(
    RingRnsConvertMontgomeryDispatcher, ring_rns_scalar_convert_montgomery, ringRnsConvertMontgomeryImpl)

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_convert_montgomery)(
  ...
  eIcicleError convert_montgomery(
    const scalar_rns_t* input, uint64_t size, bool is_to_montgomery, const VecOpsConfig& config, scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_scalar_convert_montgomery)(
  ...
  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_bit_reverse)(
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_bit_reverse)(input, size, &config, output);
  }

  ICICLE_DISPATCHER_INST(RingRnsSliceDispatcher, ring_rns_slice, ringRnsSliceOpImpl)

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_slice)(
  ...
  eIcicleError slice(
    ...
    scalar_rns_t* output)
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_slice)(input, offset, stride, size_in, size_out, &config, output);
  }

  ICICLE_DISPATCHER_INST(VectorProductRingRnsDispatcher, ring_rns_vector_product, ringRnsVectorReduceOpImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_product)(
    const scalar_rns_t* vec_a, uint64_t size, const VecOpsConfig* config, scalar_rns_t* output)
  {
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_vector_product)(vec_a, size, &config, output);
  }
