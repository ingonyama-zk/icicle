...
namespace icicle {
  ...
  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_ntt)(
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_ntt)(input, size, dir, &config, output);
  }

  // /*************************** INIT DOMAIN ***************************/
  ICICLE_DISPATCHER_INST(NttInitDomainRingRnsDispatcher, ring_rns_ntt_init_domain, NttInitDomainRingRnsImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_ntt_init_domain)(
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_ntt_init_domain)(&primitive_root, &config);
  }

  //   /*************************** RELEASE DOMAIN ***************************/
  ICICLE_DISPATCHER_INST(NttReleaseDomainRingRnsDispatcher, ring_rns_ntt_release_domain, NttReleaseDomainRingRnsImpl);

  extern "C" eIcicleError CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_ntt_release_domain)()
  {
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_ntt_release_domain)();
  }

  /*************************** GET ROOT OF UNITY ***************************/
  extern "C" eIcicleError
  CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_get_root_of_unity)(uint64_t max_size, scalar_rns_t* rou)
  {
    const auto log_max_size = static_cast<uint32_t>(std::ceil(std::log2(max_size)));
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_get_root_of_unity)(max_size, rou);
  }
  ...
  extern "C" eIcicleError
  CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_get_root_of_unity_from_domain)(uint64_t logn, scalar_rns_t* rou)
  {
  ...
  {
    return CONCAT_EXPAND(ICICLE_FFI_PREFIX, ring_rns_get_root_of_unity_from_domain)(logn, rou);
  }
#endif // RING
} // namespace icicle