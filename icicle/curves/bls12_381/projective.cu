...
extern "C" int projective_to_affine_bls12_381(BLS12_381::affine_t* out, BLS12_381::projective_t* point1)
{
  try {
    out[0] = BLS12_381::projective_t::to_affine(*point1);
    return CUDA_SUCCESS;
  } catch (const std::runtime_error& ex) {
    printf("error %s", ex.what());
    return -1;
...
extern "C" int projective_from_affine_bls12_381(BLS12_381::projective_t* out, BLS12_381::affine_t* point1)
{
  try {
    out[0] = BLS12_381::projective_t::from_affine(*point1);
    return CUDA_SUCCESS;
  } catch (const std::runtime_error& ex) {
    printf("error %s", ex.what());
    return -1;
...
extern "C" int g2_projective_to_affine_bls12_381(BLS12_381::g2_affine_t* out, BLS12_381::g2_projective_t* point1)
{
  try {
    out[0] = BLS12_381::g2_projective_t::to_affine(*point1);
    return CUDA_SUCCESS;
  } catch (const std::runtime_error& ex) {
    printf("error %s", ex.what());
    return -1;
...
extern "C" int g2_projective_from_affine_bls12_381(BLS12_381::g2_projective_t* out, BLS12_381::g2_affine_t* point1)
{
  try {
    out[0] = BLS12_381::g2_projective_t::from_affine(*point1);
    return CUDA_SUCCESS;
  } catch (const std::runtime_error& ex) {
    printf("error %s", ex.what());
    return -1;
