...
extern "C" int32_t mult_proj_batch_vec_cuda_bls12_381(
  BLS12_381::projective_t* inout,
  BLS12_381::scalar_t* scalar_vec,
  size_t n_scalars,
  size_t batch_size,
...
extern "C" int32_t mult_sc_batch_vec_cuda_bls12_381(
  BLS12_381::scalar_t* inout, BLS12_381::scalar_t* mult_vec, size_t n_mult, size_t batch_size, size_t device_id)
{
  try {
    // TODO: device_id
