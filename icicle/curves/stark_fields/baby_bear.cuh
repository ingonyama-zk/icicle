...
Field<baby_bear::fp_config>::multiply_raw_device(const ff_storage& as, const ff_storage& bs, ff_wide_storage& rs)
{
 ...
 * \f$ bs = 2^{32*nof_limbs} - p \f$.
 */
template<> __device__ __forceinline__ void
Field<baby_bear::fp_config>::multiply_and_add_lsb_neg_modulus_raw_device(const ff_storage& as, ff_storage& cs, ff_storage& rs)
{
