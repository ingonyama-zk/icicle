...
TYPED_TEST(FieldApiTest, FieldLimbsTypeSanityTest)
{
  ...
  for (int i = 0; i < 100; i++) {
    ...
    host_math::template multiply_raw<TypeParam::TLC, TypeParam::TLC, true>(
      b.limbs_storage, b.limbs_storage, r2_wide.limbs_storage);
    host_math::template add_sub_limbs<TypeParam::TLC, false, false>(a.limbs_storage, a.limbs_storage, a.limbs_storage);
    host_math::template add_sub_limbs<TypeParam::TLC, false, false, true>(
      b.limbs_storage, b.limbs_storage, b.limbs_storage);
