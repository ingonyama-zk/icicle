#include "poseidon/constants.h"
#include "icicle/errors.h"
#include "cpu_utils/device_context.h"
...
namespace poseidon {
  template <typename S>
  eIcicleError create_optimized_poseidon_constants(
    unsigned int arity,
    unsigned int alpha,
  ...
  template <typename S>
  eIcicleError init_optimized_poseidon_constants(
  ...
  template <typename S>
  eIcicleError release_optimized_poseidon_constants(PoseidonConstants<S>* constants, device_context::DeviceContext& ctx)
  {
    constants->arity = 0;
