...
namespace ntt {
  ...
  cudaError_t ntt_cuda(const E* input, int size, NTTDir dir, NTTConfig<S>& config, int device_id, E* output);
  ...
  public:
    ...
    friend cudaError_t
    ntt_cuda<U, E>(const E* input, int size, NTTDir dir, NTTConfig<U>& config, int device_id, E* output);
  };
