...
//         out: *mut Point_BLS_12_381,
//         points: *const PointAffineNoInfinity_BLS_12_381,
//         scalars: *const ScalarField_BLS_12_381,
//         count: usize,
//         device_id: usize,
//     ) -> c_uint;
...
//         d_out: DevicePointer<Point_BLS_12_381>,
//         d_scalars: DevicePointer<ScalarField_BLS_12_381>,
//         d_points: DevicePointer<PointAffineNoInfinity_BLS_12_381>,
//         count: usize,
//         device_id: usize,
//     ) -> c_uint;
...
//     fn build_domain_cuda_bls12_381(domain_size: usize, logn: usize, inverse: bool, device_id: usize) -> DevicePointer<ScalarField_BLS_12_381>;

//     fn ntt_cuda_bls12_381(inout: *mut ScalarField_BLS_12_381, n: usize, inverse: bool, device_id: usize) -> c_int;

//     fn ecntt_cuda_bls12_381(inout: *mut Point_BLS_12_381, n: usize, inverse: bool, device_id: usize) -> c_int;

//     fn ntt_batch_cuda_bls12_381(
//         inout: *mut ScalarField_BLS_12_381,
//         arr_size: usize,
//         n: usize,
//         inverse: bool,
//     ) -> c_int;

//     fn ecntt_batch_cuda_bls12_381(inout: *mut Point_BLS_12_381, arr_size: usize, n: usize, inverse: bool) -> c_int;

//     fn interpolate_scalars_cuda_bls12_381(
//         d_out: DevicePointer<ScalarField_BLS_12_381>,
//         d_evaluations: DevicePointer<ScalarField_BLS_12_381>,
//         d_domain: DevicePointer<ScalarField_BLS_12_381>, 
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         d_out: DevicePointer<Point_BLS_12_381>,
//         d_evaluations: DevicePointer<Point_BLS_12_381>,
//         d_domain: DevicePointer<ScalarField_BLS_12_381>,
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         d_out: DevicePointer<ScalarField_BLS_12_381>,
//         d_coefficients: DevicePointer<ScalarField_BLS_12_381>,
//         d_domain: DevicePointer<ScalarField_BLS_12_381>,
//         domain_size: usize,
//         n: usize,
//         device_id: usize
...
//         d_out: DevicePointer<Point_BLS_12_381>,
//         d_coefficients: DevicePointer<Point_BLS_12_381>,
//         d_domain: DevicePointer<ScalarField_BLS_12_381>,
//         domain_size: usize,
//         n: usize,
//         device_id: usize
...
//         domain_size: usize,
//         n: usize,
//         coset_powers: DevicePointer<ScalarField_BLS_12_381>,
//         device_id: usize
//     ) -> c_int;
...
//         d_arr: DevicePointer<ScalarField_BLS_12_381>,
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         d_arr: DevicePointer<Point_BLS_12_381>,
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         matrix_flattened: *const ScalarField_BLS_12_381,
//         input: *const ScalarField_BLS_12_381,
//         output: *mut ScalarField_BLS_12_381,
//         n_elements: usize,
//         device_id: usize,
//     ) -> c_int;
// }

// pub fn msm_bls12_381(points: &[PointAffineNoInfinity_BLS_12_381], scalars: &[ScalarField_BLS_12_381], device_id: usize) -> Point_BLS_12_381 {
//     let count = points.len();
//     if count != scalars.len() {
//         todo!("variable length")
//     }

//     let mut ret = Point_BLS_12_381::zero();
//     unsafe {
//         msm_cuda_bls12_381(
//             &mut ret as *mut _ as *mut Point_BLS_12_381,
//             points as *const _ as *const PointAffineNoInfinity_BLS_12_381,
//             scalars as *const _ as *const ScalarField_BLS_12_381,
//             scalars.len(),
//             device_id,
//         )
//     };
...
//     points: &[PointAffineNoInfinity_BLS_12_381],
//     scalars: &[ScalarField_BLS_12_381],
//     batch_size: usize,
//     device_id: usize,
// ) -> Vec<Point_BLS_12_381> {
//     let count = points.len();
//     if count != scalars.len() {
//         todo!("variable length")
//     }

//     let mut ret = vec![Point_BLS_12_381::zero(); batch_size];

//     unsafe {
//         msm_batch_cuda_bls12_381(
//             &mut ret[0] as *mut _ as *mut Point_BLS_12_381,
//             points as *const _ as *const PointAffineNoInfinity_BLS_12_381,
//             scalars as *const _ as *const ScalarField_BLS_12_381,
//             batch_size,
//             count / batch_size,
...
//     points: &mut DeviceBuffer<PointAffineNoInfinity_BLS_12_381>,
//     scalars: &mut DeviceBuffer<ScalarField_BLS_12_381>,
// ) -> DeviceBox<Point_BLS_12_381> {
//     let mut res = DeviceBox::new(&Point_BLS_12_381::zero()).unwrap();
//     unsafe {
...
// fn ntt_internal_bls12_381(values: &mut [ScalarField_BLS_12_381], device_id: usize, inverse: bool) -> i32 {
//     let ret_code = unsafe {
//         ntt_cuda_bls12_381(
//             values as *mut _ as *mut ScalarField_BLS_12_381,
//             values.len(),
//             inverse,
//             device_id,
//         )
...
// pub fn ntt_bls12_381(values: &mut [ScalarField_BLS_12_381], device_id: usize) {
//     ntt_internal_bls12_381(values, device_id, false);
// }

// pub fn intt_bls12_381(values: &mut [ScalarField_BLS_12_381], device_id: usize) {
//     ntt_internal_bls12_381(values, device_id, true);
// }

// /// Compute an in-place NTT on the input data.
// fn ntt_internal_batch_bls12_381(
//     values: &mut [ScalarField_BLS_12_381],
//     device_id: usize,
//     batch_size: usize,
//     inverse: bool,
// ) -> i32 {
...
// pub fn ntt_batch_bls12_381(values: &mut [ScalarField_BLS_12_381], batch_size: usize, device_id: usize) {
//     ntt_internal_batch_bls12_381(values, 0, batch_size, false);
// }

// pub fn intt_batch_bls12_381(values: &mut [ScalarField_BLS_12_381], batch_size: usize, device_id: usize) {
//     ntt_internal_batch_bls12_381(values, 0, batch_size, true);
// }

// /// Compute an in-place ECNTT on the input data.
// fn ecntt_internal_bls12_381(values: &mut [Point_BLS_12_381], inverse: bool, device_id: usize) -> i32 {
//     unsafe {
//         ecntt_cuda_bls12_381(
//             values as *mut _ as *mut Point_BLS_12_381,
//             values.len(),
//             inverse,
//             device_id,
//         )
...
// pub fn ecntt_batch_bls12_381(values: &mut [Point_BLS_12_381], batch_size: usize, device_id: usize) {
//     ecntt_internal_batch_bls12_381(values, 0, batch_size, false);
// }

// /// Compute an in-place iECNTT on the input data.
// pub fn iecntt_batch_bls12_381(values: &mut [Point_BLS_12_381], batch_size: usize, device_id: usize) {
//     ecntt_internal_batch_bls12_381(values, 0, batch_size, true);
// }

// pub fn build_domain_bls12_381(domain_size: usize, logn: usize, inverse: bool) -> DeviceBuffer<ScalarField_BLS_12_381> {
//     unsafe {
...
//     d_scalars: &mut DeviceBuffer<ScalarField_BLS_12_381>,
// ) {
...
//     d_points: &mut DeviceBuffer<Point_BLS_12_381>,
// ) {
...
//     d_evaluations: &mut DeviceBuffer<ScalarField_BLS_12_381>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_381>
// ) -> DeviceBuffer<ScalarField_BLS_12_381> {
...
//     d_evaluations: &mut DeviceBuffer<Point_BLS_12_381>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_381>,
// ) -> DeviceBuffer<Point_BLS_12_381> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
...
//     d_coefficients: &mut DeviceBuffer<ScalarField_BLS_12_381>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_381>,
// ) -> DeviceBuffer<ScalarField_BLS_12_381> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
//     unsafe {
...
//     d_coefficients: &mut DeviceBuffer<Point_BLS_12_381>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_381>,
// ) -> DeviceBuffer<Point_BLS_12_381> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
//     unsafe {
...
//     d_coefficients: &mut DeviceBuffer<ScalarField_BLS_12_381>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_381>,
//     coset_powers: &mut DeviceBuffer<ScalarField_BLS_12_381>,
// ) -> DeviceBuffer<ScalarField_BLS_12_381> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
//     unsafe {
...
// pub fn multp_vec_bls12_381(a: &mut [Point_BLS_12_381], b: &[ScalarField_BLS_12_381], device_id: usize) {
//     assert_eq!(a.len(), b.len());
//     unsafe {
//         vec_mod_mult_point_bls12_381(
//             a as *mut _ as *mut Point_BLS_12_381,
//             b as *const _ as *const ScalarField_BLS_12_381,
//             a.len(),
//             device_id,
//         );
//     }
...
// pub fn mult_sc_vec_bls12_381(a: &mut [ScalarField_BLS_12_381], b: &[ScalarField_BLS_12_381], device_id: usize) {
//     assert_eq!(a.len(), b.len());
//     unsafe {
//         vec_mod_mult_scalar_bls12_381(
//             a as *mut _ as *mut ScalarField_BLS_12_381,
//             b as *const _ as *const ScalarField_BLS_12_381,
//             a.len(),
//             device_id,
//         );
...
// pub fn mult_matrix_by_vec_bls12_381(a: &[ScalarField_BLS_12_381], b: &[ScalarField_BLS_12_381], device_id: usize) -> Vec<ScalarField_BLS_12_381> {
//     let mut c = Vec::with_capacity(b.len());
//     for i in 0..b.len() {
//         c.push(ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()});
//     }
//     unsafe {
//         matrix_vec_mod_mult_bls12_381(
//             a as *const _ as *const ScalarField_BLS_12_381,
//             b as *const _ as *const ScalarField_BLS_12_381,
//             c.as_mut_slice() as *mut _ as *mut ScalarField_BLS_12_381,
//             b.len(),
//             device_id,
//         );
//     }
...
// ) -> Vec<PointAffineNoInfinity_BLS_12_381> {
//     (0..count)
//         .map(|_| Point_BLS_12_381::from_ark(G1Projective_BLS12_381::rand(&mut rng)).to_xy_strip_z())
//         .collect()
// }

// pub fn generate_random_points_proj_bls12_381(count: usize, mut rng: Box<dyn RngCore>) -> Vec<Point_BLS_12_381> {
//     (0..count)
//         .map(|_| Point_BLS_12_381::from_ark(G1Projective_BLS12_381::rand(&mut rng)))
//         .collect()
// }

// pub fn generate_random_scalars_bls12_381(count: usize, mut rng: Box<dyn RngCore>) -> Vec<ScalarField_BLS_12_381> {
//     (0..count)
//         .map(|_| ScalarField_BLS_12_381::from_ark(Fr_BLS12_381::rand(&mut rng).into_repr()))
//         .collect()
// }

// pub fn set_up_points_bls12_381(test_size: usize, log_domain_size: usize, inverse: bool) -> (Vec<Point_BLS_12_381>, DeviceBuffer<Point_BLS_12_381>, DeviceBuffer<ScalarField_BLS_12_381>) {
...
// pub fn set_up_scalars_bls12_381(test_size: usize, log_domain_size: usize, inverse: bool) -> (Vec<ScalarField_BLS_12_381>, DeviceBuffer<ScalarField_BLS_12_381>, DeviceBuffer<ScalarField_BLS_12_381>) {
//     set_up_device_bls12_381();
...
//                 Point_BLS_12_381::from_ark(msm_result_ark).to_ark_affine()
//             );
//         }
//     }
...
//                     .map(|p| Point_BLS_12_381::from_ark(VariableBaseMSM::multi_scalar_mul(p.0, p.1)))
//                     .collect();
...
//         let mut h_commit_result = Point_BLS_12_381::zero();
//         d_commit_result.copy_to(&mut h_commit_result).unwrap();

//         assert_eq!(msm_result, h_commit_result);
//         assert_ne!(msm_result, Point_BLS_12_381::zero());
//         assert_ne!(h_commit_result, Point_BLS_12_381::zero());
//     }
...
//         let mut h_commit_result: Vec<Point_BLS_12_381> = (0..batch_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_commit_result.copy_to(&mut h_commit_result[..]).unwrap();

//         assert_eq!(msm_result, h_commit_result);
//         for h in h_commit_result {
//             assert_ne!(h, Point_BLS_12_381::zero());
//         }
//     }
...
//         let scalars_batch: Vec<ScalarField_BLS_12_381> =
//             generate_random_scalars_bls12_381(test_size * batches, get_rng_bls12_381(seed));

//         let mut scalar_vec_of_vec: Vec<Vec<ScalarField_BLS_12_381>> = Vec::new();
...
//         let mut points_vec_of_vec: Vec<Vec<Point_BLS_12_381>> = Vec::new();
...
//         let mut h_coeffs: Vec<ScalarField_BLS_12_381> = (0..test_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
...
//         let mut h_coeffs: Vec<ScalarField_BLS_12_381> = (0..test_size * batch_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
//         d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
...
//         let mut h_coeffs: Vec<Point_BLS_12_381> = (0..test_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
...
//         let mut h_coeffs: Vec<Point_BLS_12_381> = (0..test_size * batch_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
...
//         let mut h_coeffs_domain: Vec<ScalarField_BLS_12_381> = (0..1 << log_test_domain_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
...
//             assert_eq!(ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}, h_coeffs_domain[i]);
//         }
//     }
...
//         let mut h_coeffs_domain: Vec<ScalarField_BLS_12_381> = (0..domain_size * batch_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
//         d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();
...
//                 assert_eq!(ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}, h_coeffs_domain[j * domain_size + i]);
//             }
//         }
//     }
...
//         let mut h_coeffs_domain: Vec<Point_BLS_12_381> = (0..1 << log_test_domain_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

//         assert_eq!(h_coeffs[..], h_coeffs_domain[..coeff_size]);
//         for i in coeff_size..(1 << log_test_domain_size) {
//             assert_eq!(Point_BLS_12_381::zero(), h_coeffs_domain[i]);
//         }
//         for i in 0..coeff_size {
//             assert_ne!(h_coeffs_domain[i], Point_BLS_12_381::zero());
//         }
//     }
...
//         let mut h_coeffs_domain: Vec<Point_BLS_12_381> = (0..domain_size * batch_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

//         for j in 0..batch_size {
//             assert_eq!(h_coeffs[j * coeff_size..(j + 1) * coeff_size], h_coeffs_domain[j * domain_size..(j * domain_size + coeff_size)]);
//             for i in coeff_size..domain_size {
//                 assert_eq!(Point_BLS_12_381::zero(), h_coeffs_domain[j * domain_size + i]);
//             }
...
//         let mut d_evals = evaluate_scalars_bls12_381(&mut d_coeffs, &mut d_domain);
//         let mut h_coeffs: Vec<ScalarField_BLS_12_381> = (0..1 << log_test_domain_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
...
//         let mut h_evals_coset: Vec<ScalarField_BLS_12_381> = (0..1 << log_test_domain_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
...
//         let mut h_evals_large: Vec<ScalarField_BLS_12_381> = (0..2 * test_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_scalars_bls12_381(&mut d_coeffs, &mut d_domain);
//         let mut h_evals: Vec<ScalarField_BLS_12_381> = (0..test_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
...
//         let mut h_evals_coset: Vec<ScalarField_BLS_12_381> = (0..test_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
...
//         let mut h_evals_large: Vec<ScalarField_BLS_12_381> = (0..2 * test_size * batch_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_scalars_batch_bls12_381(&mut d_coeffs, &mut d_domain, batch_size);
//         let mut h_evals: Vec<ScalarField_BLS_12_381> = (0..test_size * batch_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
//         d_evals.copy_to(&mut h_evals[..]).unwrap();
//         let mut d_evals_coset = evaluate_scalars_on_coset_batch_bls12_381(&mut d_coeffs, &mut d_domain, batch_size, &mut d_coset_powers);
//         let mut h_evals_coset: Vec<ScalarField_BLS_12_381> = (0..test_size * batch_size).map(|_| ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
...
//         let mut h_evals_large: Vec<Point_BLS_12_381> = (0..2 * test_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_points_bls12_381(&mut d_coeffs, &mut d_domain);
//         let mut h_evals: Vec<Point_BLS_12_381> = (0..test_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_evals.copy_to(&mut h_evals[..]).unwrap();
//         let mut d_evals_coset = evaluate_points_on_coset_bls12_381(&mut d_coeffs, &mut d_domain, &mut d_coset_powers);
//         let mut h_evals_coset: Vec<Point_BLS_12_381> = (0..test_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();

//         assert_eq!(h_evals[..], h_evals_large[..test_size]);
//         assert_eq!(h_evals_coset[..], h_evals_large[test_size..2 * test_size]);
//         for i in 0..test_size {
//             assert_ne!(h_evals[i], Point_BLS_12_381::zero());
//             assert_ne!(h_evals_coset[i], Point_BLS_12_381::zero());
//             assert_ne!(h_evals_large[2 * i], Point_BLS_12_381::zero());
//             assert_ne!(h_evals_large[2 * i + 1], Point_BLS_12_381::zero());
//         }
//     }
...
//         let mut h_evals_large: Vec<Point_BLS_12_381> = (0..2 * test_size * batch_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_points_batch_bls12_381(&mut d_coeffs, &mut d_domain, batch_size);
//         let mut h_evals: Vec<Point_BLS_12_381> = (0..test_size * batch_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_evals.copy_to(&mut h_evals[..]).unwrap();
//         let mut d_evals_coset = evaluate_points_on_coset_batch_bls12_381(&mut d_coeffs, &mut d_domain, batch_size, &mut d_coset_powers);
//         let mut h_evals_coset: Vec<Point_BLS_12_381> = (0..test_size * batch_size).map(|_| Point_BLS_12_381::zero()).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
...
//         let matrix_flattened: Vec<ScalarField_BLS_12_381> = (0..test_size).map(
//             |row_num| { (0..test_size).map( 
//                 |col_num| {
//                     let pow: [u64; 1] = [(row_num * col_num).try_into().unwrap()];
//                     ScalarField_BLS_12_381::from_ark(Fr::pow(&rou, &pow).into_repr())
//                 }).collect::<Vec<ScalarField_BLS_12_381>>()
//             }).flatten().collect::<Vec<_>>();
//         let vector: Vec<ScalarField_BLS_12_381> = generate_random_scalars_bls12_381(test_size, get_rng_bls12_381(seed));
...
//         let mut intoo = [ScalarField_BLS_12_381{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_381{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}];
//         let expected = [ScalarField_BLS_12_381{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}, ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}];
...
//         let dummy_one = Point_BLS_12_381 {
//             x: BaseField_BLS_12_381{ inner_scalar: ScalarT::one()},
//             y: BaseField_BLS_12_381{ inner_scalar: ScalarT::zero()},
//             z: BaseField_BLS_12_381{ inner_scalar: ScalarT::one()},
//         };

//         let mut inout = [dummy_one, dummy_one, Point_BLS_12_381::zero()];
//         let scalars = [ScalarField_BLS_12_381{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}, ScalarField_BLS_12_381{inner_scalar: ScalarT::zero()}];
//         let expected = [
//             Point_BLS_12_381::zero(),
//             Point_BLS_12_381 {
//                 x: BaseField_BLS_12_381{ inner_scalar: ScalarT::zero()},
//                 y: BaseField_BLS_12_381{ inner_scalar: ScalarT::one()},
//                 z: BaseField_BLS_12_381{ inner_scalar: ScalarT::zero()},
//             },
//             Point_BLS_12_381 {
//                 x: BaseField_BLS_12_381{ inner_scalar: ScalarT::zero()},
//                 y: BaseField_BLS_12_381{ inner_scalar: ScalarT::one()},
...
//         out: *mut Point_BLS_12_377,
//         points: *const PointAffineNoInfinity_BLS_12_377,
//         scalars: *const ScalarField_BLS_12_377,
//         count: usize,
//         device_id: usize,
//     ) -> c_uint;
...
//         d_out: DevicePointer<Point_BLS_12_377>,
//         d_scalars: DevicePointer<ScalarField_BLS_12_377>,
//         d_points: DevicePointer<PointAffineNoInfinity_BLS_12_377>,
//         count: usize,
//         device_id: usize,
//     ) -> c_uint;
...
//     fn build_domain_cuda_bls12_377(domain_size: usize, logn: usize, inverse: bool, device_id: usize) -> DevicePointer<ScalarField_BLS_12_377>;

//     fn ntt_cuda_bls12_377(inout: *mut ScalarField_BLS_12_377, n: usize, inverse: bool, device_id: usize) -> c_int;

//     fn ecntt_cuda_bls12_377(inout: *mut Point_BLS_12_377, n: usize, inverse: bool, device_id: usize) -> c_int;

//     fn ntt_batch_cuda_bls12_377(
//         inout: *mut ScalarField_BLS_12_377,
//         arr_size: usize,
//         n: usize,
//         inverse: bool,
//     ) -> c_int;

//     fn ecntt_batch_cuda_bls12_377(inout: *mut Point_BLS_12_377, arr_size: usize, n: usize, inverse: bool) -> c_int;

//     fn interpolate_scalars_cuda_bls12_377(
//         d_out: DevicePointer<ScalarField_BLS_12_377>,
//         d_evaluations: DevicePointer<ScalarField_BLS_12_377>,
//         d_domain: DevicePointer<ScalarField_BLS_12_377>, 
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         d_out: DevicePointer<Point_BLS_12_377>,
//         d_evaluations: DevicePointer<Point_BLS_12_377>,
//         d_domain: DevicePointer<ScalarField_BLS_12_377>,
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         d_out: DevicePointer<ScalarField_BLS_12_377>,
//         d_coefficients: DevicePointer<ScalarField_BLS_12_377>,
//         d_domain: DevicePointer<ScalarField_BLS_12_377>,
//         domain_size: usize,
//         n: usize,
//         device_id: usize
...
//         d_out: DevicePointer<Point_BLS_12_377>,
//         d_coefficients: DevicePointer<Point_BLS_12_377>,
//         d_domain: DevicePointer<ScalarField_BLS_12_377>,
//         domain_size: usize,
//         n: usize,
//         device_id: usize
...
//         domain_size: usize,
//         n: usize,
//         coset_powers: DevicePointer<ScalarField_BLS_12_377>,
//         device_id: usize
//     ) -> c_int;
...
//         d_arr: DevicePointer<ScalarField_BLS_12_377>,
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         d_arr: DevicePointer<Point_BLS_12_377>,
//         n: usize,
//         device_id: usize
//     ) -> c_int;
...
//         matrix_flattened: *const ScalarField_BLS_12_377,
//         input: *const ScalarField_BLS_12_377,
//         output: *mut ScalarField_BLS_12_377,
//         n_elements: usize,
//         device_id: usize,
//     ) -> c_int;
// }

// pub fn msm_bls12_377(points: &[PointAffineNoInfinity_BLS_12_377], scalars: &[ScalarField_BLS_12_377], device_id: usize) -> Point_BLS_12_377 {
//     let count = points.len();
//     if count != scalars.len() {
//         todo!("variable length")
//     }

//     let mut ret = Point_BLS_12_377::zero();
//     unsafe {
//         msm_cuda_bls12_377(
//             &mut ret as *mut _ as *mut Point_BLS_12_377,
//             points as *const _ as *const PointAffineNoInfinity_BLS_12_377,
//             scalars as *const _ as *const ScalarField_BLS_12_377,
//             scalars.len(),
//             device_id,
//         )
//     };
...
//     points: &[PointAffineNoInfinity_BLS_12_377],
//     scalars: &[ScalarField_BLS_12_377],
//     batch_size: usize,
//     device_id: usize,
// ) -> Vec<Point_BLS_12_377> {
//     let count = points.len();
//     if count != scalars.len() {
//         todo!("variable length")
//     }

//     let mut ret = vec![Point_BLS_12_377::zero(); batch_size];

//     unsafe {
//         msm_batch_cuda_bls12_377(
//             &mut ret[0] as *mut _ as *mut Point_BLS_12_377,
//             points as *const _ as *const PointAffineNoInfinity_BLS_12_377,
//             scalars as *const _ as *const ScalarField_BLS_12_377,
//             batch_size,
//             count / batch_size,
...
//     points: &mut DeviceBuffer<PointAffineNoInfinity_BLS_12_377>,
//     scalars: &mut DeviceBuffer<ScalarField_BLS_12_377>,
// ) -> DeviceBox<Point_BLS_12_377> {
//     let mut res = DeviceBox::new(&Point_BLS_12_377::zero()).unwrap();
//     unsafe {
...
// /// Compute an in-place NTT on the input data.
// fn ntt_internal_bls12_377(values: &mut [ScalarField_BLS_12_377], device_id: usize, inverse: bool) -> i32 {
//     let ret_code = unsafe {
//         ntt_cuda_bls12_377(
//             values as *mut _ as *mut ScalarField_BLS_12_377,
//             values.len(),
//             inverse,
//             device_id,
//         )
...
// pub fn ntt_bls12_377(values: &mut [ScalarField_BLS_12_377], device_id: usize) {
//     ntt_internal_bls12_377(values, device_id, false);
// }

// pub fn intt_bls12_377(values: &mut [ScalarField_BLS_12_377], device_id: usize) {
//     ntt_internal_bls12_377(values, device_id, true);
// }

// /// Compute an in-place NTT on the input data.
// fn ntt_internal_batch_bls12_377(
//     values: &mut [ScalarField_BLS_12_377],
//     device_id: usize,
//     batch_size: usize,
//     inverse: bool,
// ) -> i32 {
...
// pub fn ntt_batch_bls12_377(values: &mut [ScalarField_BLS_12_377], batch_size: usize, device_id: usize) {
//     ntt_internal_batch_bls12_377(values, 0, batch_size, false);
// }

// pub fn intt_batch_bls12_377(values: &mut [ScalarField_BLS_12_377], batch_size: usize, device_id: usize) {
//     ntt_internal_batch_bls12_377(values, 0, batch_size, true);
// }

// /// Compute an in-place ECNTT on the input data.
// fn ecntt_internal_bls12_377(values: &mut [Point_BLS_12_377], inverse: bool, device_id: usize) -> i32 {
//     unsafe {
//         ecntt_cuda_bls12_377(
//             values as *mut _ as *mut Point_BLS_12_377,
//             values.len(),
//             inverse,
//             device_id,
//         )
...
// pub fn ecntt_bls12_377(values: &mut [Point_BLS_12_377], device_id: usize) {
//     ecntt_internal_bls12_377(values, false, device_id);
// }

// /// Compute an in-place iECNTT on the input data.
// pub fn iecntt_bls12_377(values: &mut [Point_BLS_12_377], device_id: usize) {
//     ecntt_internal_bls12_377(values, true, device_id);
// }

// /// Compute an in-place ECNTT on the input data.
// fn ecntt_internal_batch_bls12_377(
//     values: &mut [Point_BLS_12_377],
//     device_id: usize,
//     batch_size: usize,
//     inverse: bool,
// ) -> i32 {
...
// pub fn ecntt_batch_bls12_377(values: &mut [Point_BLS_12_377], batch_size: usize, device_id: usize) {
//     ecntt_internal_batch_bls12_377(values, 0, batch_size, false);
// }

// /// Compute an in-place iECNTT on the input data.
// pub fn iecntt_batch_bls12_377(values: &mut [Point_BLS_12_377], batch_size: usize, device_id: usize) {
//     ecntt_internal_batch_bls12_377(values, 0, batch_size, true);
// }

// pub fn build_domain_bls12_377(domain_size: usize, logn: usize, inverse: bool) -> DeviceBuffer<ScalarField_BLS_12_377> {
//     unsafe {
...
//     d_scalars: &mut DeviceBuffer<ScalarField_BLS_12_377>,
// ) {
...
//     d_points: &mut DeviceBuffer<Point_BLS_12_377>,
// ) {
...
//     d_evaluations: &mut DeviceBuffer<ScalarField_BLS_12_377>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_377>
// ) -> DeviceBuffer<ScalarField_BLS_12_377> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
...
//     d_evaluations: &mut DeviceBuffer<Point_BLS_12_377>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_377>,
// ) -> DeviceBuffer<Point_BLS_12_377> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
...
//     d_coefficients: &mut DeviceBuffer<ScalarField_BLS_12_377>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_377>,
// ) -> DeviceBuffer<ScalarField_BLS_12_377> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
//     unsafe {
...
//     d_coefficients: &mut DeviceBuffer<Point_BLS_12_377>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_377>,
// ) -> DeviceBuffer<Point_BLS_12_377> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
//     unsafe {
...
//     d_coefficients: &mut DeviceBuffer<ScalarField_BLS_12_377>,
//     d_domain: &mut DeviceBuffer<ScalarField_BLS_12_377>,
//     coset_powers: &mut DeviceBuffer<ScalarField_BLS_12_377>,
// ) -> DeviceBuffer<ScalarField_BLS_12_377> {
//     let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
//     unsafe {
...
// pub fn multp_vec_bls12_377(a: &mut [Point_BLS_12_377], b: &[ScalarField_BLS_12_377], device_id: usize) {
//     assert_eq!(a.len(), b.len());
//     unsafe {
//         vec_mod_mult_point_bls12_377(
//             a as *mut _ as *mut Point_BLS_12_377,
//             b as *const _ as *const ScalarField_BLS_12_377,
//             a.len(),
//             device_id,
//         );
//     }
...
// pub fn mult_sc_vec_bls12_377(a: &mut [ScalarField_BLS_12_377], b: &[ScalarField_BLS_12_377], device_id: usize) {
//     assert_eq!(a.len(), b.len());
//     unsafe {
//         vec_mod_mult_scalar_bls12_377(
//             a as *mut _ as *mut ScalarField_BLS_12_377,
//             b as *const _ as *const ScalarField_BLS_12_377,
//             a.len(),
//             device_id,
//         );
...
// //  `a` - flattenned matrix;
// //  `b` - vector to multiply `a` by;
// pub fn mult_matrix_by_vec_bls12_377(a: &[ScalarField_BLS_12_377], b: &[ScalarField_BLS_12_377], device_id: usize) -> Vec<ScalarField_BLS_12_377> {
//     let mut c = Vec::with_capacity(b.len());
//     for i in 0..b.len() {
//         c.push(ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()});
//     }
//     unsafe {
//         matrix_vec_mod_mult_bls12_377(
//             a as *const _ as *const ScalarField_BLS_12_377,
//             b as *const _ as *const ScalarField_BLS_12_377,
//             c.as_mut_slice() as *mut _ as *mut ScalarField_BLS_12_377,
//             b.len(),
//             device_id,
//         );
//     }
...
//     count: usize,
//     mut rng: Box<dyn RngCore>,
// ) -> Vec<PointAffineNoInfinity_BLS_12_377> {
//     (0..count)
//         .map(|_| Point_BLS_12_377::from_ark(G1Projective_BLS12_377::rand(&mut rng)).to_xy_strip_z())
//         .collect()
// }

// pub fn generate_random_points_proj_bls12_377(count: usize, mut rng: Box<dyn RngCore>) -> Vec<Point_BLS_12_377> {
//     (0..count)
//         .map(|_| Point_BLS_12_377::from_ark(G1Projective_BLS12_377::rand(&mut rng)))
//         .collect()
// }

// pub fn generate_random_scalars_bls12_377(count: usize, mut rng: Box<dyn RngCore>) -> Vec<ScalarField_BLS_12_377> {
//     (0..count)
//         .map(|_| ScalarField_BLS_12_377::from_ark(Fr_BLS12_377::rand(&mut rng).into_repr()))
//         .collect()
// }

// pub fn set_up_points_bls12_377(test_size: usize, log_domain_size: usize, inverse: bool) -> (Vec<Point_BLS_12_377>, DeviceBuffer<Point_BLS_12_377>, DeviceBuffer<ScalarField_BLS_12_377>) {
...
// pub fn set_up_scalars_bls12_377(test_size: usize, log_domain_size: usize, inverse: bool) -> (Vec<ScalarField_BLS_12_377>, DeviceBuffer<ScalarField_BLS_12_377>, DeviceBuffer<ScalarField_BLS_12_377>) {
//     set_up_device_bls12_377();
...
//             assert_eq!(
//                 msm_result.to_ark_affine(),
//                 Point_BLS_12_377::from_ark(msm_result_ark).to_ark_affine()
//             );
//         }
//     }
...
//                     .chunks(msm_size)
//                     .zip(scalars_r_ark.chunks(msm_size))
//                     .map(|p| Point_BLS_12_377::from_ark(VariableBaseMSM::multi_scalar_mul(p.0, p.1)))
//                     .collect();
...
//         let mut h_commit_result = Point_BLS_12_377::zero();
//         d_commit_result.copy_to(&mut h_commit_result).unwrap();

//         assert_eq!(msm_result, h_commit_result);
//         assert_ne!(msm_result, Point_BLS_12_377::zero());
//         assert_ne!(h_commit_result, Point_BLS_12_377::zero());
//     }
...
//         let mut h_commit_result: Vec<Point_BLS_12_377> = (0..batch_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_commit_result.copy_to(&mut h_commit_result[..]).unwrap();

//         assert_eq!(msm_result, h_commit_result);
//         for h in h_commit_result {
//             assert_ne!(h, Point_BLS_12_377::zero());
//         }
//     }
...
//         let scalars_batch: Vec<ScalarField_BLS_12_377> =
//             generate_random_scalars_bls12_377(test_size * batches, get_rng_bls12_377(seed));

//         let mut scalar_vec_of_vec: Vec<Vec<ScalarField_BLS_12_377>> = Vec::new();
...
//         let mut points_vec_of_vec: Vec<Vec<Point_BLS_12_377>> = Vec::new();
...
//         let mut h_coeffs: Vec<ScalarField_BLS_12_377> = (0..test_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
...
//         let mut h_coeffs: Vec<ScalarField_BLS_12_377> = (0..test_size * batch_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
...
//         let mut h_coeffs: Vec<Point_BLS_12_377> = (0..test_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
...
//         let mut h_coeffs: Vec<Point_BLS_12_377> = (0..test_size * batch_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
...
//         let mut h_coeffs_domain: Vec<ScalarField_BLS_12_377> = (0..1 << log_test_domain_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

//         assert_eq!(h_coeffs, h_coeffs_domain[..coeff_size]);
//         for i in coeff_size.. (1 << log_test_domain_size) {
//             assert_eq!(ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}, h_coeffs_domain[i]);
//         }
//     }
...
//         let mut h_coeffs_domain: Vec<ScalarField_BLS_12_377> = (0..domain_size * batch_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

//         for j in 0..batch_size {
//             assert_eq!(h_coeffs[j * coeff_size..(j + 1) * coeff_size], h_coeffs_domain[j * domain_size..j * domain_size + coeff_size]);
//             for i in coeff_size..domain_size {
//                 assert_eq!(ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}, h_coeffs_domain[j * domain_size + i]);
//             }
//         }
//     }
...
//         let mut h_coeffs_domain: Vec<Point_BLS_12_377> = (0..1 << log_test_domain_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

//         assert_eq!(h_coeffs[..], h_coeffs_domain[..coeff_size]);
//         for i in coeff_size..(1 << log_test_domain_size) {
//             assert_eq!(Point_BLS_12_377::zero(), h_coeffs_domain[i]);
//         }
//         for i in 0..coeff_size {
//             assert_ne!(h_coeffs_domain[i], Point_BLS_12_377::zero());
//         }
//     }
...
//         let mut h_coeffs_domain: Vec<Point_BLS_12_377> = (0..domain_size * batch_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

//         for j in 0..batch_size {
//             assert_eq!(h_coeffs[j * coeff_size..(j + 1) * coeff_size], h_coeffs_domain[j * domain_size..(j * domain_size + coeff_size)]);
//             for i in coeff_size..domain_size {
//                 assert_eq!(Point_BLS_12_377::zero(), h_coeffs_domain[j * domain_size + i]);
//             }
//             for i in j * domain_size..(j * domain_size + coeff_size) {
//                 assert_ne!(h_coeffs_domain[i], Point_BLS_12_377::zero());
//             }
...
//         let mut d_evals = evaluate_scalars_bls12_377(&mut d_coeffs, &mut d_domain);
//         let mut h_coeffs: Vec<ScalarField_BLS_12_377> = (0..1 << log_test_domain_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals.copy_to(&mut h_coeffs[..]).unwrap();
//         let mut d_evals_coset = evaluate_scalars_on_coset_bls12_377(&mut d_coeffs, &mut d_domain, &mut d_trivial_coset_powers);
//         let mut h_evals_coset: Vec<ScalarField_BLS_12_377> = (0..1 << log_test_domain_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
...
//         let mut h_evals_large: Vec<ScalarField_BLS_12_377> = (0..2 * test_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_scalars_bls12_377(&mut d_coeffs, &mut d_domain);
//         let mut h_evals: Vec<ScalarField_BLS_12_377> = (0..test_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals.copy_to(&mut h_evals[..]).unwrap();
//         let mut d_evals_coset = evaluate_scalars_on_coset_bls12_377(&mut d_coeffs, &mut d_domain, &mut d_coset_powers);
//         let mut h_evals_coset: Vec<ScalarField_BLS_12_377> = (0..test_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
...
//         let mut h_evals_large: Vec<ScalarField_BLS_12_377> = (0..2 * test_size * batch_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_scalars_batch_bls12_377(&mut d_coeffs, &mut d_domain, batch_size);
//         let mut h_evals: Vec<ScalarField_BLS_12_377> = (0..test_size * batch_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals.copy_to(&mut h_evals[..]).unwrap();
//         let mut d_evals_coset = evaluate_scalars_on_coset_batch_bls12_377(&mut d_coeffs, &mut d_domain, batch_size, &mut d_coset_powers);
//         let mut h_evals_coset: Vec<ScalarField_BLS_12_377> = (0..test_size * batch_size).map(|_| ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
...
//         let mut h_evals_large: Vec<Point_BLS_12_377> = (0..2 * test_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_points_bls12_377(&mut d_coeffs, &mut d_domain);
//         let mut h_evals: Vec<Point_BLS_12_377> = (0..test_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_evals.copy_to(&mut h_evals[..]).unwrap();
//         let mut d_evals_coset = evaluate_points_on_coset_bls12_377(&mut d_coeffs, &mut d_domain, &mut d_coset_powers);
//         let mut h_evals_coset: Vec<Point_BLS_12_377> = (0..test_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();

//         assert_eq!(h_evals[..], h_evals_large[..test_size]);
//         assert_eq!(h_evals_coset[..], h_evals_large[test_size..2 * test_size]);
//         for i in 0..test_size {
//             assert_ne!(h_evals[i], Point_BLS_12_377::zero());
//             assert_ne!(h_evals_coset[i], Point_BLS_12_377::zero());
//             assert_ne!(h_evals_large[2 * i], Point_BLS_12_377::zero());
//             assert_ne!(h_evals_large[2 * i + 1], Point_BLS_12_377::zero());
//         }
//     }
...
//         let mut h_evals_large: Vec<Point_BLS_12_377> = (0..2 * test_size * batch_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
//         let mut d_evals = evaluate_points_batch_bls12_377(&mut d_coeffs, &mut d_domain, batch_size);
//         let mut h_evals: Vec<Point_BLS_12_377> = (0..test_size * batch_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_evals.copy_to(&mut h_evals[..]).unwrap();
//         let mut d_evals_coset = evaluate_points_on_coset_batch_bls12_377(&mut d_coeffs, &mut d_domain, batch_size, &mut d_coset_powers);
//         let mut h_evals_coset: Vec<Point_BLS_12_377> = (0..test_size * batch_size).map(|_| Point_BLS_12_377::zero()).collect();
//         d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
...
//         let test_size = 1 << 5;
//         let rou = Fr::get_root_of_unity(test_size).unwrap();
//         let matrix_flattened: Vec<ScalarField_BLS_12_377> = (0..test_size).map(
//             |row_num| { (0..test_size).map( 
//                 |col_num| {
//                     let pow: [u64; 1] = [(row_num * col_num).try_into().unwrap()];
//                     ScalarField_BLS_12_377::from_ark(Fr::pow(&rou, &pow).into_repr())
//                 }).collect::<Vec<ScalarField_BLS_12_377>>()
//             }).flatten().collect::<Vec<_>>();
//         let vector: Vec<ScalarField_BLS_12_377> = generate_random_scalars_bls12_377(test_size, get_rng_bls12_377(seed));
...
//     #[allow(non_snake_case)]
//     fn test_vec_scalar_mul() {
//         let mut intoo = [ScalarField_BLS_12_377{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_377{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}];
//         let expected = [ScalarField_BLS_12_377{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}, ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}];
...
//     #[allow(non_snake_case)]
//     fn test_vec_point_mul() {
//         let dummy_one = Point_BLS_12_377 {
//             x: BaseField_BLS_12_377{ inner_scalar: ScalarT::one()},
//             y: BaseField_BLS_12_377{ inner_scalar: ScalarT::zero()},
//             z: BaseField_BLS_12_377{ inner_scalar: ScalarT::one()},
//         };

//         let mut inout = [dummy_one, dummy_one, Point_BLS_12_377::zero()];
//         let scalars = [ScalarField_BLS_12_377{inner_scalar: ScalarT::one()}, ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}, ScalarField_BLS_12_377{inner_scalar: ScalarT::zero()}];
//         let expected = [
...
extern "C" {
    fn msm_cuda_bn254(
        out: *mut Point_BN_254,
        points: *const PointAffineNoInfinity_BN_254,
        scalars: *const ScalarField_BN_254,
        count: usize,
        device_id: usize,
    ) -> c_uint;
    ...
    fn commit_cuda_bn254(
        d_out: DevicePointer<Point_BN_254>,
        d_scalars: DevicePointer<ScalarField_BN_254>,
        d_points: DevicePointer<PointAffineNoInfinity_BN_254>,
        count: usize,
        device_id: usize,
    ) -> c_uint;
    ...
    fn build_domain_cuda_bn254(domain_size: usize, logn: usize, inverse: bool, device_id: usize) -> DevicePointer<ScalarField_BN_254>;

    fn ntt_cuda_bn254(inout: *mut ScalarField_BN_254, n: usize, inverse: bool, device_id: usize) -> c_int;

    fn ecntt_cuda_bn254(inout: *mut Point_BN_254, n: usize, inverse: bool, device_id: usize) -> c_int;

    fn ntt_batch_cuda_bn254(
        inout: *mut ScalarField_BN_254,
        arr_size: usize,
        n: usize,
        inverse: bool,
    ) -> c_int;

    fn ecntt_batch_cuda_bn254(inout: *mut Point_BN_254, arr_size: usize, n: usize, inverse: bool) -> c_int;

    fn interpolate_scalars_cuda_bn254(
        d_out: DevicePointer<ScalarField_BN_254>,
        d_evaluations: DevicePointer<ScalarField_BN_254>,
        d_domain: DevicePointer<ScalarField_BN_254>, 
        n: usize,
        device_id: usize
    ) -> c_int;
    ...
    fn interpolate_points_cuda_bn254(
        d_out: DevicePointer<Point_BN_254>,
        d_evaluations: DevicePointer<Point_BN_254>,
        d_domain: DevicePointer<ScalarField_BN_254>,
        n: usize,
        device_id: usize
    ) -> c_int;
    ...
    fn evaluate_scalars_cuda_bn254(
        d_out: DevicePointer<ScalarField_BN_254>,
        d_coefficients: DevicePointer<ScalarField_BN_254>,
        d_domain: DevicePointer<ScalarField_BN_254>,
        domain_size: usize,
        n: usize,
        device_id: usize
    ...
    fn evaluate_points_cuda_bn254(
        d_out: DevicePointer<Point_BN_254>,
        d_coefficients: DevicePointer<Point_BN_254>,
        d_domain: DevicePointer<ScalarField_BN_254>,
        domain_size: usize,
        n: usize,
        device_id: usize
    ...
    fn evaluate_scalars_on_coset_cuda_bn254(
        ...
        domain_size: usize,
        n: usize,
        coset_powers: DevicePointer<ScalarField_BN_254>,
        device_id: usize
    ) -> c_int;
    ...
    fn reverse_order_scalars_cuda_bn254(
        d_arr: DevicePointer<ScalarField_BN_254>,
        n: usize,
        device_id: usize
    ) -> c_int;
    ...
    fn reverse_order_points_cuda_bn254(
        d_arr: DevicePointer<Point_BN_254>,
        n: usize,
        device_id: usize
    ) -> c_int;
    ...
    fn matrix_vec_mod_mult_bn254(
        matrix_flattened: *const ScalarField_BN_254,
        input: *const ScalarField_BN_254,
        output: *mut ScalarField_BN_254,
        n_elements: usize,
        device_id: usize,
    ) -> c_int;
}

pub fn msm_bn254(points: &[PointAffineNoInfinity_BN_254], scalars: &[ScalarField_BN_254], device_id: usize) -> Point_BN_254 {
    let count = points.len();
    if count != scalars.len() {
        todo!("variable length")
    }

    let mut ret = Point_BN_254::zero();
    unsafe {
        msm_cuda_bn254(
            &mut ret as *mut _ as *mut Point_BN_254,
            points as *const _ as *const PointAffineNoInfinity_BN_254,
            scalars as *const _ as *const ScalarField_BN_254,
            scalars.len(),
            device_id,
        )
    };
...
pub fn msm_batch_bn254(
    points: &[PointAffineNoInfinity_BN_254],
    scalars: &[ScalarField_BN_254],
    batch_size: usize,
    device_id: usize,
) -> Vec<Point_BN_254> {
    let count = points.len();
    ...
    let mut ret = vec![Point_BN_254::zero(); batch_size];

    unsafe {
        msm_batch_cuda_bn254(
            &mut ret[0] as *mut _ as *mut Point_BN_254,
            points as *const _ as *const PointAffineNoInfinity_BN_254,
            scalars as *const _ as *const ScalarField_BN_254,
            batch_size,
            count / batch_size,
...
pub fn commit_bn254(
    points: &mut DeviceBuffer<PointAffineNoInfinity_BN_254>,
    scalars: &mut DeviceBuffer<ScalarField_BN_254>,
) -> DeviceBox<Point_BN_254> {
    let mut res = DeviceBox::new(&Point_BN_254::zero()).unwrap();
    unsafe {
        commit_cuda_bn254(
            res.as_device_ptr(),
            scalars.as_device_ptr(),
...
/// Compute an in-place NTT on the input data.
fn ntt_internal_bn254(values: &mut [ScalarField_BN_254], device_id: usize, inverse: bool) -> i32 {
    let ret_code = unsafe {
        ntt_cuda_bn254(
            values as *mut _ as *mut ScalarField_BN_254,
            values.len(),
            inverse,
            device_id,
        )
...
pub fn ntt_bn254(values: &mut [ScalarField_BN_254], device_id: usize) {
    ntt_internal_bn254(values, device_id, false);
}

pub fn intt_bn254(values: &mut [ScalarField_BN_254], device_id: usize) {
    ntt_internal_bn254(values, device_id, true);
}

/// Compute an in-place NTT on the input data.
fn ntt_internal_batch_bn254(
    values: &mut [ScalarField_BN_254],
    device_id: usize,
    batch_size: usize,
    inverse: bool,
) -> i32 {
...
pub fn ntt_batch_bn254(values: &mut [ScalarField_BN_254], batch_size: usize, device_id: usize) {
    ntt_internal_batch_bn254(values, 0, batch_size, false);
}

pub fn intt_batch_bn254(values: &mut [ScalarField_BN_254], batch_size: usize, device_id: usize) {
    ntt_internal_batch_bn254(values, 0, batch_size, true);
}

/// Compute an in-place ECNTT on the input data.
fn ecntt_internal_bn254(values: &mut [Point_BN_254], inverse: bool, device_id: usize) -> i32 {
    unsafe {
        ecntt_cuda_bn254(
            values as *mut _ as *mut Point_BN_254,
            values.len(),
            inverse,
            device_id,
        )
...
pub fn ecntt_bn254(values: &mut [Point_BN_254], device_id: usize) {
    ecntt_internal_bn254(values, false, device_id);
}

/// Compute an in-place iECNTT on the input data.
pub fn iecntt_bn254(values: &mut [Point_BN_254], device_id: usize) {
    ecntt_internal_bn254(values, true, device_id);
}

/// Compute an in-place ECNTT on the input data.
fn ecntt_internal_batch_bn254(
    values: &mut [Point_BN_254],
    device_id: usize,
    batch_size: usize,
    inverse: bool,
) -> i32 {
...
pub fn ecntt_batch_bn254(values: &mut [Point_BN_254], batch_size: usize, device_id: usize) {
    ecntt_internal_batch_bn254(values, 0, batch_size, false);
}

/// Compute an in-place iECNTT on the input data.
pub fn iecntt_batch_bn254(values: &mut [Point_BN_254], batch_size: usize, device_id: usize) {
    ecntt_internal_batch_bn254(values, 0, batch_size, true);
}

pub fn build_domain_bn254(domain_size: usize, logn: usize, inverse: bool) -> DeviceBuffer<ScalarField_BN_254> {
    unsafe {
...
pub fn reverse_order_scalars_bn254(
    d_scalars: &mut DeviceBuffer<ScalarField_BN_254>,
) {
...
pub fn reverse_order_points_bn254(
    d_points: &mut DeviceBuffer<Point_BN_254>,
) {
...
pub fn interpolate_scalars_bn254(
    d_evaluations: &mut DeviceBuffer<ScalarField_BN_254>,
    d_domain: &mut DeviceBuffer<ScalarField_BN_254>
) -> DeviceBuffer<ScalarField_BN_254> {
    let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
...
pub fn interpolate_points_bn254(
    d_evaluations: &mut DeviceBuffer<Point_BN_254>,
    d_domain: &mut DeviceBuffer<ScalarField_BN_254>,
) -> DeviceBuffer<Point_BN_254> {
    let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
...
pub fn evaluate_scalars_bn254(
    d_coefficients: &mut DeviceBuffer<ScalarField_BN_254>,
    d_domain: &mut DeviceBuffer<ScalarField_BN_254>,
) -> DeviceBuffer<ScalarField_BN_254> {
    let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
    unsafe {
...
pub fn evaluate_points_bn254(
    d_coefficients: &mut DeviceBuffer<Point_BN_254>,
    d_domain: &mut DeviceBuffer<ScalarField_BN_254>,
) -> DeviceBuffer<Point_BN_254> {
    let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
    unsafe {
...
pub fn evaluate_scalars_on_coset_bn254(
    d_coefficients: &mut DeviceBuffer<ScalarField_BN_254>,
    d_domain: &mut DeviceBuffer<ScalarField_BN_254>,
    coset_powers: &mut DeviceBuffer<ScalarField_BN_254>,
) -> DeviceBuffer<ScalarField_BN_254> {
    let mut res = unsafe { DeviceBuffer::uninitialized(d_domain.len()).unwrap() };
    unsafe {
...
pub fn multp_vec_bn254(a: &mut [Point_BN_254], b: &[ScalarField_BN_254], device_id: usize) {
    assert_eq!(a.len(), b.len());
    unsafe {
        vec_mod_mult_point_bn254(
            a as *mut _ as *mut Point_BN_254,
            b as *const _ as *const ScalarField_BN_254,
            a.len(),
            device_id,
        );
    }
...
pub fn mult_sc_vec_bn254(a: &mut [ScalarField_BN_254], b: &[ScalarField_BN_254], device_id: usize) {
    assert_eq!(a.len(), b.len());
    unsafe {
        vec_mod_mult_scalar_bn254(
            a as *mut _ as *mut ScalarField_BN_254,
            b as *const _ as *const ScalarField_BN_254,
            a.len(),
            device_id,
        );
...
//  `a` - flattenned matrix;
//  `b` - vector to multiply `a` by;
pub fn mult_matrix_by_vec_bn254(a: &[ScalarField_BN_254], b: &[ScalarField_BN_254], device_id: usize) -> Vec<ScalarField_BN_254> {
    let mut c = Vec::with_capacity(b.len());
    for i in 0..b.len() {
        c.push(ScalarField_BN_254{inner_scalar: ScalarT::zero()});
    }
    unsafe {
        matrix_vec_mod_mult_bn254(
            a as *const _ as *const ScalarField_BN_254,
            b as *const _ as *const ScalarField_BN_254,
            c.as_mut_slice() as *mut _ as *mut ScalarField_BN_254,
            b.len(),
            device_id,
        );
    }
...
pub fn generate_random_points_bn254(
    count: usize,
    mut rng: Box<dyn RngCore>,
) -> Vec<PointAffineNoInfinity_BN_254> {
    (0..count)
        .map(|_| Point_BN_254::from_ark(G1Projective_BN254::rand(&mut rng)).to_xy_strip_z())
        .collect()
}

pub fn generate_random_points_proj_bn254(count: usize, mut rng: Box<dyn RngCore>) -> Vec<Point_BN_254> {
    (0..count)
        .map(|_| Point_BN_254::from_ark(G1Projective_BN254::rand(&mut rng)))
        .collect()
}

pub fn generate_random_scalars_bn254(count: usize, mut rng: Box<dyn RngCore>) -> Vec<ScalarField_BN_254> {
    (0..count)
        .map(|_| ScalarField_BN_254::from_ark(Fr_BN254::rand(&mut rng).into_repr()))
        .collect()
}

pub fn set_up_points_bn254(test_size: usize, log_domain_size: usize, inverse: bool) -> (Vec<Point_BN_254>, DeviceBuffer<Point_BN_254>, DeviceBuffer<ScalarField_BN_254>) {
    set_up_device_bn254();
...
pub fn set_up_scalars_bn254(test_size: usize, log_domain_size: usize, inverse: bool) -> (Vec<ScalarField_BN_254>, DeviceBuffer<ScalarField_BN_254>, DeviceBuffer<ScalarField_BN_254>) {
    set_up_device_bn254();
...
pub(crate) mod tests_bn254 {
    ...
    fn test_msm() {
        ...
        for pow2 in test_sizes {
            ...
            let msm_result_ark = VariableBaseMSM::multi_scalar_mul(&point_r_ark, &scalars_r_ark).into_affine();

            assert_eq!(msm_result.to_ark_affine(), msm_result_ark);
            assert_eq!(msm_result.to_ark(), msm_result_ark);
            // assert_eq!(
            //     msm_result.to_ark_affine(),
            //     Point_BN_254::from_ark(msm_result_ark).to_ark_affine()
            // );
        }
    }
        ...
        for batch_pow2 in [2, 4] {
            for pow2 in [4, 6] {
                ...
                let expected: Vec<_> = point_r_ark
                    .chunks(msm_size)
                    .zip(scalars_r_ark.chunks(msm_size))
                    .map(|p| Point_BN_254::from_ark(VariableBaseMSM::multi_scalar_mul(p.0, p.1)))
                    .collect();
    ...
    fn test_commit() {
        ...
        let mut h_commit_result = Point_BN_254::zero();
        d_commit_result.copy_to(&mut h_commit_result).unwrap();

        assert_eq!(msm_result, h_commit_result);
        assert_ne!(msm_result, Point_BN_254::zero());
        assert_ne!(h_commit_result, Point_BN_254::zero());
    }
    ...
    fn test_batch_commit() {
        ...
        let mut h_commit_result: Vec<Point_BN_254> = (0..batch_size).map(|_| Point_BN_254::zero()).collect();
        d_commit_result.copy_to(&mut h_commit_result[..]).unwrap();

        assert_eq!(msm_result, h_commit_result);
        for h in h_commit_result {
            assert_ne!(h, Point_BN_254::zero());
        }
    }
    ...
    fn test_ntt_batch() {
        ...
        let scalars_batch: Vec<ScalarField_BN_254> =
            generate_random_scalars_bn254(test_size * batches, get_rng_bn254(seed));

        let mut scalar_vec_of_vec: Vec<Vec<ScalarField_BN_254>> = Vec::new();
        ...
        let mut points_vec_of_vec: Vec<Vec<Point_BN_254>> = Vec::new();
    ...
    fn test_scalar_interpolation() {
        ...
        let mut h_coeffs: Vec<ScalarField_BN_254> = (0..test_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
    ...
    fn test_scalar_batch_interpolation() {
        ...
        let mut h_coeffs: Vec<ScalarField_BN_254> = (0..test_size * batch_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
    ...
    fn test_point_interpolation() {
        ...
        let mut h_coeffs: Vec<Point_BN_254> = (0..test_size).map(|_| Point_BN_254::zero()).collect();
        d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
    ...
    fn test_point_batch_interpolation() {
        ...
        let mut h_coeffs: Vec<Point_BN_254> = (0..test_size * batch_size).map(|_| Point_BN_254::zero()).collect();
        d_coeffs.copy_to(&mut h_coeffs[..]).unwrap();
    ...
    fn test_scalar_evaluation() {
        ...
        let mut h_coeffs_domain: Vec<ScalarField_BN_254> = (0..1 << log_test_domain_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

        assert_eq!(h_coeffs, h_coeffs_domain[..coeff_size]);
        for i in coeff_size.. (1 << log_test_domain_size) {
            assert_eq!(ScalarField_BN_254{inner_scalar: ScalarT::zero()}, h_coeffs_domain[i]);
        }
    }
    ...
    fn test_scalar_batch_evaluation() {
        ...
        let mut h_coeffs_domain: Vec<ScalarField_BN_254> = (0..domain_size * batch_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

        for j in 0..batch_size {
            assert_eq!(h_coeffs[j * coeff_size..(j + 1) * coeff_size], h_coeffs_domain[j * domain_size..j * domain_size + coeff_size]);
            for i in coeff_size..domain_size {
                assert_eq!(ScalarField_BN_254{inner_scalar: ScalarT::zero()}, h_coeffs_domain[j * domain_size + i]);
            }
        }
    }
    ...
    fn test_point_evaluation() {
        ...
        let mut h_coeffs_domain: Vec<Point_BN_254> = (0..1 << log_test_domain_size).map(|_| Point_BN_254::zero()).collect();
        d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

        assert_eq!(h_coeffs[..], h_coeffs_domain[..coeff_size]);
        for i in coeff_size..(1 << log_test_domain_size) {
            assert_eq!(Point_BN_254::zero(), h_coeffs_domain[i]);
        }
        for i in 0..coeff_size {
            assert_ne!(h_coeffs_domain[i], Point_BN_254::zero());
        }
    }
    ...
    fn test_point_batch_evaluation() {
        ...
        let mut h_coeffs_domain: Vec<Point_BN_254> = (0..domain_size * batch_size).map(|_| Point_BN_254::zero()).collect();
        d_coeffs_domain.copy_to(&mut h_coeffs_domain[..]).unwrap();

        for j in 0..batch_size {
            assert_eq!(h_coeffs[j * coeff_size..(j + 1) * coeff_size], h_coeffs_domain[j * domain_size..(j * domain_size + coeff_size)]);
            for i in coeff_size..domain_size {
                assert_eq!(Point_BN_254::zero(), h_coeffs_domain[j * domain_size + i]);
            }
            for i in j * domain_size..(j * domain_size + coeff_size) {
                assert_ne!(h_coeffs_domain[i], Point_BN_254::zero());
            }
    ...
    fn test_scalar_evaluation_on_trivial_coset() {
        ...
        let mut d_evals = evaluate_scalars_bn254(&mut d_coeffs, &mut d_domain);
        let mut h_coeffs: Vec<ScalarField_BN_254> = (0..1 << log_test_domain_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals.copy_to(&mut h_coeffs[..]).unwrap();
        let mut d_evals_coset = evaluate_scalars_on_coset_bn254(&mut d_coeffs, &mut d_domain, &mut d_trivial_coset_powers);
        let mut h_evals_coset: Vec<ScalarField_BN_254> = (0..1 << log_test_domain_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
    ...
    fn test_scalar_evaluation_on_coset() {
        ...
        let mut h_evals_large: Vec<ScalarField_BN_254> = (0..2 * test_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
        let mut d_evals = evaluate_scalars_bn254(&mut d_coeffs, &mut d_domain);
        let mut h_evals: Vec<ScalarField_BN_254> = (0..test_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals.copy_to(&mut h_evals[..]).unwrap();
        let mut d_evals_coset = evaluate_scalars_on_coset_bn254(&mut d_coeffs, &mut d_domain, &mut d_coset_powers);
        let mut h_evals_coset: Vec<ScalarField_BN_254> = (0..test_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
    ...
    fn test_scalar_batch_evaluation_on_coset() {
        ...
        let mut h_evals_large: Vec<ScalarField_BN_254> = (0..2 * test_size * batch_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
        let mut d_evals = evaluate_scalars_batch_bn254(&mut d_coeffs, &mut d_domain, batch_size);
        let mut h_evals: Vec<ScalarField_BN_254> = (0..test_size * batch_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals.copy_to(&mut h_evals[..]).unwrap();
        let mut d_evals_coset = evaluate_scalars_on_coset_batch_bn254(&mut d_coeffs, &mut d_domain, batch_size, &mut d_coset_powers);
        let mut h_evals_coset: Vec<ScalarField_BN_254> = (0..test_size * batch_size).map(|_| ScalarField_BN_254{inner_scalar: ScalarT::zero()}).collect();
        d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
    ...
    fn test_point_evaluation_on_coset() {
        ...
        let mut h_evals_large: Vec<Point_BN_254> = (0..2 * test_size).map(|_| Point_BN_254::zero()).collect();
        d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
        let mut d_evals = evaluate_points_bn254(&mut d_coeffs, &mut d_domain);
        let mut h_evals: Vec<Point_BN_254> = (0..test_size).map(|_| Point_BN_254::zero()).collect();
        d_evals.copy_to(&mut h_evals[..]).unwrap();
        let mut d_evals_coset = evaluate_points_on_coset_bn254(&mut d_coeffs, &mut d_domain, &mut d_coset_powers);
        let mut h_evals_coset: Vec<Point_BN_254> = (0..test_size).map(|_| Point_BN_254::zero()).collect();
        d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();

        assert_eq!(h_evals[..], h_evals_large[..test_size]);
        assert_eq!(h_evals_coset[..], h_evals_large[test_size..2 * test_size]);
        for i in 0..test_size {
            assert_ne!(h_evals[i], Point_BN_254::zero());
            assert_ne!(h_evals_coset[i], Point_BN_254::zero());
            assert_ne!(h_evals_large[2 * i], Point_BN_254::zero());
            assert_ne!(h_evals_large[2 * i + 1], Point_BN_254::zero());
        }
    }
    ...
    fn test_point_batch_evaluation_on_coset() {
        ...
        let mut h_evals_large: Vec<Point_BN_254> = (0..2 * test_size * batch_size).map(|_| Point_BN_254::zero()).collect();
        d_evals_large.copy_to(&mut h_evals_large[..]).unwrap();
        let mut d_evals = evaluate_points_batch_bn254(&mut d_coeffs, &mut d_domain, batch_size);
        let mut h_evals: Vec<Point_BN_254> = (0..test_size * batch_size).map(|_| Point_BN_254::zero()).collect();
        d_evals.copy_to(&mut h_evals[..]).unwrap();
        let mut d_evals_coset = evaluate_points_on_coset_batch_bn254(&mut d_coeffs, &mut d_domain, batch_size, &mut d_coset_powers);
        let mut h_evals_coset: Vec<Point_BN_254> = (0..test_size * batch_size).map(|_| Point_BN_254::zero()).collect();
        d_evals_coset.copy_to(&mut h_evals_coset[..]).unwrap();
    ...
    fn test_matrix_multiplication() {
        ...
        let test_size = 1 << 5;
        let rou = Fr::get_root_of_unity(test_size).unwrap();
        let matrix_flattened: Vec<ScalarField_BN_254> = (0..test_size).map(
            |row_num| { (0..test_size).map( 
                |col_num| {
                    let pow: [u64; 1] = [(row_num * col_num).try_into().unwrap()];
                    ScalarField_BN_254::from_ark(Fr::pow(&rou, &pow).into_repr())
                }).collect::<Vec<ScalarField_BN_254>>()
            }).flatten().collect::<Vec<_>>();
        let vector: Vec<ScalarField_BN_254> = generate_random_scalars_bn254(test_size, get_rng_bn254(seed));
    ...
    #[allow(non_snake_case)]
    fn test_vec_scalar_mul() {
        let mut intoo = [ScalarField_BN_254{inner_scalar: ScalarT::one()}, ScalarField_BN_254{inner_scalar: ScalarT::one()}, ScalarField_BN_254{inner_scalar: ScalarT::zero()}];
        let expected = [ScalarField_BN_254{inner_scalar: ScalarT::one()}, ScalarField_BN_254{inner_scalar: ScalarT::zero()}, ScalarField_BN_254{inner_scalar: ScalarT::zero()}];
    ...
    #[allow(non_snake_case)]
    fn test_vec_point_mul() {
        let dummy_one = Point_BN_254 {
            x: BaseField_BN_254{ inner_scalar: ScalarT::one()},
            y: BaseField_BN_254{ inner_scalar: ScalarT::zero()},
            z: BaseField_BN_254{ inner_scalar: ScalarT::one()},
        };

        let mut inout = [dummy_one, dummy_one, Point_BN_254::zero()];
        let scalars = [ScalarField_BN_254{inner_scalar: ScalarT::one()}, ScalarField_BN_254{inner_scalar: ScalarT::zero()}, ScalarField_BN_254{inner_scalar: ScalarT::zero()}];
        let expected = [
            Point_BN_254::zero(),
            Point_BN_254 {
