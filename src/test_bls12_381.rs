...
extern "C" {
    ...
    fn reverse_order_points_cuda_bls12_381(d_arr: DevicePointer<Point_BLS12_381>, n: usize, device_id: usize) -> c_int;
...
pub fn reverse_order_scalars_batch_bls12_381(d_scalars: &mut DeviceBuffer<ScalarField_BLS12_381>, batch_size: usize) {
    unsafe {
...
pub fn reverse_order_points_batch_bls12_381(d_points: &mut DeviceBuffer<Point_BLS12_381>, batch_size: usize) {
    unsafe {
...
pub(crate) mod tests_bls12_381 {
    ...
    fn test_batch_commit() {
        ...
        let mut h_commit_result: Vec<Point_BLS12_381> = (0..batch_size)
    ...
    fn test_point_interpolation() {
        ...
        let mut h_coeffs: Vec<Point_BLS12_381> = (0..test_size)
            .map(|_| Point_BLS12_381::zero())
            .collect();
        d_coeffs
            .copy_to(&mut h_coeffs[..])
    ...
    fn test_point_evaluation_on_coset() {
        ...
        let mut h_evals: Vec<Point_BLS12_381> = (0..test_size)
            .map(|_| Point_BLS12_381::zero())
            .collect();
        d_evals
            .copy_to(&mut h_evals[..])
        ...
        let mut h_evals_coset: Vec<Point_BLS12_381> = (0..test_size)
            .map(|_| Point_BLS12_381::zero())
            .collect();
        d_evals_coset
            .copy_to(&mut h_evals_coset[..])
