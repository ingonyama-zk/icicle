...
extern "C" {
    ...
    fn build_domain_cuda_bls12_377(domain_size: usize, logn: usize, inverse: bool, device_id: usize) -> DevicePointer<Scalar>;

    fn ntt_cuda_bls12_377(inout: *mut Scalar, n: usize, inverse: bool, device_id: usize) -> c_int;

    fn ecntt_cuda_bls12_377(inout: *mut Point, n: usize, inverse: bool, device_id: usize) -> c_int;
    ...
    fn ecntt_batch_cuda_bls12_377(inout: *mut Point, arr_size: usize, n: usize, inverse: bool) -> c_int;
